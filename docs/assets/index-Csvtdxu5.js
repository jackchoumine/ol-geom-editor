...
let Wg = 0
function K(n) {
  return n.ol_uid || (n.ol_uid = String(++Wg))
}
class wl extends Et {
  constructor(t, e, i) {
    ;(super(t), (this.key = e), (this.oldValue = i))
...
function Zg(n, t, e, i, s) {
  const [r, o, a, l, h, c, u, d] = Kg(n, t, e, i)
...
function y_(n) {
  ;(r_(n.getCode(), n), $s(n, n, fa))
}
function p_(n) {
  n.forEach(y_)
}
function vt(n) {
  return typeof n == 'string' ? s_(n) : n || null
}
function Pl(n) {
  ;(p_(n),
    n.forEach(function (t) {
...
Ye.includes('firefox')
const w_ = Ye.includes('safari') && !Ye.includes('chrom')
w_ && (Ye.includes('version/15.4') || /cpu (os|iphone os) 15_4 like mac os x/.test(Ye))
...
function k_(n, t, e, i, s, r, o, a, l, h, c) {
  c = c || [NaN, NaN]
  for (let u = 0, d = e.length; u < d; ++u) {
    const f = e[u]
...
function Wc(n, t, e, i, s, r, o, a) {
  for (let l = 0, h = e.length; l < h; ++l) {
    const c = e[l]
    ;((o = j_(n, t, c, i, s, r, o)), a.push(o), (t = c))
  }
  return o
}
...
function Vc(n, t, e, i, s) {
  if (!V_(n, t, e[0], i, s)) return !1
  if (e.length === 1) return !0
  for (let r = 1, o = e.length; r < o; ++r)
    if (W_(n, e[r - 1], e[r], i, s) && !Rr(n, e[r - 1], e[r], i, s)) return !1
  return !0
}
...
class ci extends Ke {
  ...
  getSimplifiedGeometryInternal(t) {
    const e = [],
      i = []
    return ((e.length = G_(this.flatCoordinates, 0, this.ends_, this.stride, t, e, 0, i)), new ci(e, 'XY', i))
  }
  getType() {
...
function vo(n, t, e, i, s) {
  ...
  for (let r = 0, o = e.length; r < o; ++r) {
    const a = e[r],
      l = qc(n, t, a, i)
    ;((r === 0 ? (s && l) || (!s && !l) : (s && !l) || (!s && l)) && $_(n, t, a, i), (t = a))
  }
  return t
}
...
function H_(n, t, e, i) {
  e = e || 32
  const s = []
  for (let r = 0; r < e; ++r) re(s, g_(n, t, (2 * Math.PI * r) / e, i))
...
class ui extends Ke {
  ...
  closestPointXY(t, e, i, s) {
    return s < _i(this.getExtent(), t, e)
      ...
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ...
          (this.maxDeltaRevision_ = this.getRevision())),
        k_(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, this.maxDelta_, !0, t, e, i, s))
  }
  containsXY(t, e) {
  ...
  setCoordinates(t, e) {
    ...
    const i = N_(this.flatCoordinates, 0, t, this.stride, this.endss_)
...
function er(n) {
  return Array.isArray(n) ? n : Em(n)
}
function xm(n) {
  let t, e, i, s, r
  if ((ym.exec(n) && (n = pm(n)), mm.exec(n))) {
    const o = n.length - 1
    let a
    o <= 4 ? (a = 1) : (a = 2)
    const l = o === 4 || o === 8
...
class Tm extends Ec {
  ...
  load() {
    if (this.imageState_ === tt.IDLE) {
      ...
      this.unlisten_ = wm(this.image_, this.handleImageLoad_.bind(this), this.handleImageError_.bind(this))
    }
  }
  replaceColor_(t) {
...
function bm(n, t, e, i, s, r, o, a, l, h, c) {
  ;(n.save(),
    e !== 1 && (n.globalAlpha *= e),
...
const Dm = { POINT: Wt, LINESTRING: $t, POLYGON: Yt, MULTIPOINT: ln, MULTILINESTRING: ci, MULTIPOLYGON: ui },
  su = 'EMPTY',
  ru = 'Z',
  ou = 'M',
  km = 'ZM',
...
class jm {
  ...
  parseGeometryLayout_() {
    ...
    if (this.isTokenType(z.TEXT)) {
      const i = e.value
      ;(i === ru ? (t = 'XYZ') : i === ou ? (t = 'XYM') : i === km && (t = 'XYZM'),
        t !== 'XY' && this.consume_())
    }
    return t
  }
...
class Ul extends we {
  ...
  calculateCenterRotate(t, e) {
    let i
    const s = this.getCenterInternal()
    return (s !== void 0 && ((i = [s[0] - e[0], s[1] - e[1]]), c_(i, t - this.getRotation()), l_(i, e)), i)
  }
  calculateCenterZoom(t, e) {
    let i
    const s = this.getCenterInternal(),
  ...
  calculateExtentInternal(t) {
    ...
    et(i !== void 0, 2)
    const s = this.getRotation()
    return (et(s !== void 0, 3), Zg(e, i, s, t))
  }
  getMaxResolution() {
    return this.maxResolution_
  }
  ...
  resolveConstraints(t, e, i) {
    ...
    ;((i = i || (t === 0 ? this.cancelAnchor_ : void 0)),
      ...
      (this.getResolution() !== a ||
        ...
        (this.getAnimating() && this.cancelAnimations(),
        this.animateInternal({ rotation: r, center: l, resolution: a, duration: t, easing: Zm, anchor: i })))
  }
  beginInteraction() {
...
function f0(n) {
  ...
  if ((!h && !_ && d.isGlobal() && ((g = !1), (_ = f)), n.resolutions !== void 0)) {
    ...
    ;((e = m[o]),
      (i = m[a] !== void 0 ? m[a] : m[m.length - 1]),
      n.constrainResolution ? (t = c0(m, c, !g && _, u)) : (t = Vl(e, i, c, !g && _, u)))
  } else {
    const y = (f ? Math.max(zt(f), bn(f)) : (360 * Ac.degrees) / d.getMetersPerUnit()) / l0 / Math.pow(2, zr),
    ...
    ;((e = n.maxResolution),
      ...
      (a = o + Math.floor(Math.log(e / i) / Math.log(l))),
      (i = e / Math.pow(l, a - o)),
      n.constrainResolution ? (t = u0(l, e, i, c, !g && _, u)) : (t = Vl(e, i, c, !g && _, u)))
  }
  return { constraint: t, maxResolution: e, minResolution: i, minZoom: o, zoomFactor: l }
}
function g0(n) {
  if (n.enableRotation !== void 0 ? n.enableRotation : !0) {
    const e = n.constrainRotation
    return e === void 0 || e === !0 ? s0() : e === !1 ? Yl : typeof e == 'number' ? n0(e) : Yl
  }
  return i0
}
function _0(n) {
...
class m0 extends a0 {
  ...
  isVisible(t) {
    ...
    e.layerStatesArray ? (s = e.layerStatesArray.find(o => o.layer === this)) : (s = this.getLayerState())
    const r = this.getExtent()
    return y0(s, e.viewState) && (!r || Xt(r, e.extent))
  }
  getAttributions(t) {
    if (!this.isVisible(t)) return []
    let e
...
function Zl(n, t, e, i, s) {
  ...
  for (; r.length; ) {
    ...
    ;(p0(n, o, t, e, s), r.push(t, o, o, e))
  }
}
function Kl(n) {
  return new Kt({ fill: Gn(n, ''), stroke: jn(n, ''), text: S0(n), image: v0(n) })
}
function Gn(n, t) {
...
class Jn extends du {
  ...
  appendFlatPointCoordinates(t, e) {
    ...
    for (let a = 0, l = t.length; a < l; a += e)
      ((s[0] = t[a]), (s[1] = t[a + 1]), Vg(i, s) && ((r[o++] = s[0]), (r[o++] = s[1])))
    return o
  }
  ...
  drawText(t, e) {
    ...
    if (
      ...
      for (let _ = 0, m = u.length; _ < m; ++_) {
        let y
        d ? (y = b0(d * this.resolution, h, g, u[_], c)) : (y = [h.slice(g, u[_])])
        for (let p = 0, E = y.length; p < E; ++p) {
          const x = y[p]
          let C = 0,
            w = x.length
          if (f == null) {
            const S = L0(r.maxAngle, x, 0, x.length, 2)
            ;((C = S[0]), (w = S[1]))
          }
...
const F0 = { Circle: Hl, Default: Jn, Image: M0, LineString: P0, Polygon: Hl, Text: A0 }
class Jl {
  constructor(t, e, i, s) {
    ;((this.tolerance_ = t),
      (this.maxExtent_ = e),
...
class N0 extends O0 {
  ...
  dispatchRenderEvent_(t, e, i) {
    const s = this.getLayer()
    if (s.hasListener(t)) {
      const r = new D0(t, this.inversePixelTransform, i, e)
      s.dispatchEvent(r)
    }
  }
  preRender(t, e) {
...
function G0(n, t, e, i, s, r, o, a, l, h, c, u) {
  let d = n[t],
    f = n[t + 1],
    g = 0,
    _ = 0,
...
`,
            ...
            .reduce(j0, []),
      { width: _, height: m, widths: y, heights: p, lineWidths: E } = Pm(l, g),
      x = _ + f,
      C = [],
      w = (x + 2) * c[0],
      v = (m + f) * c[1],
        ...
        case M.DRAW_CHARS:
          ...
          if (bu || ja <= Ga) {
            const Mt = this.textStates[w].textAlign,
              Ci = (Ga - ja) * Vr(C, Mt),
              Ot = G0(h, rs, gt, 2, C, Ci, Lu, Math.abs(dn[0]), zl, un, fn, I ? 0 : this.viewRotation_)
            t: if (Ot) {
              const ce = []
              let Pt, os, as, Ct, Dt
              if (v)
...
function nh(n, t, e, i, s, r, o) {
  ...
  return ($0(n, t, e, i, r, o), a)
}
function $0(n, t, e, i, s, r) {
...
class ny extends N0 {
  ...
  renderFrame(t, e) {
    ...
    ;(I_(this.pixelTransform, 1 / i, 1 / i), M_(this.inversePixelTransform, this.pixelTransform))
    const r = b_(this.pixelTransform)
  ...
  getFeatures(t) {
    return new Promise(e => {
      if (!this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
        ...
        this.hitDetectionImageData_ = Y0(i, c, this.renderedFeatures_, h.getStyleFunction(), l, r, o)
      }
...
class Pa extends sy {
  constructor(t) {
    ;((t = t || {}),
      ...
      (this.strategy_ = t.strategy !== void 0 ? t.strategy : ry))
...
class cy extends vr {
  ...
  updateTrace_(t) {
    ...
    const i = hy(t.coordinate, e, this.getMap(), this.snapTolerance_)
...
function lh(n, t, e) {
  ...
  const s = J(n)
  return ((qi[0] = J(t.segment[0])), (qi[1] = J(t.segment[1])), u_(s, qi))
}
function hh(n, t, e) {
  const i = t.geometry
  ...
  handleEvent(t) {
    ...
    return (
      e &&
        ...
        this.dispatchEvent(
          new yy(my.SNAP, { vertex: t.coordinate, vertexPixel: t.pixel, feature: e.feature }),
        )),
      super.handleEvent(t)
    )
  }
...
const Cy = Object.assign,
  ...
  pu = n => Ty.call(n),
  Sy = n => pu(n).slice(8, -1),
  ba = n => wy(n) && n !== 'NaN' && n[0] !== '-' && '' + parseInt(n, 10) === n,
...
function io(n, t, e) {
  ...
  St(i, 'iterate', Xn)
  const s = i[t](...e)
  return (s === -1 || s === !1) && Vy(e[0]) ? ((e[0] = H(e[0])), i[t](...e)) : s
}
function pn(n, t, e = []) {
  ;(Iy(), La())
...
class wu {
  ...
  get(t, e, i) {
    ...
    if (e === '__v_raw')
      return i === (s ? (r ? Wy : vu) : r ? zy : Su).get(t) ||
...
function By(n) {
  return n.__v_skip || !Object.isExtensible(n) ? 0 : Yy(Sy(n))
}
function Iu(n) {
  return rn(n) ? n : Pu(n, !1, Dy, jy, Su)
}
function Mu(n) {
  return Pu(n, !0, ky, Xy, vu)
}
...
const e1 = ['Point', 'LineString', 'Polygon', 'Circle'],
  i1 = getComputedStyle(document.documentElement).getPropertyValue('--ol-foreground-color'),
  n1 = new Kt({
  ...
  s1 = { duration: 500, maxZoom: 14, padding: 100 },
...
class o1 extends we {
  ...
  select(t, e) {
    ...
    if (
      ...
      const c = s1
      ;(e?.fit !== !1 && (Object.assign(c, e?.fit === !0 ? {} : e?.fit), (c.padding = t1(c.padding))),
        this.#m.fit(a, c))
    }
    return l
  }
  ...
  enableTranslate(t) {
    return (
      ...
      this.#l.value
        ...
        : ((this.#l.value = new Ey({ features: this.#e })),
  ...
  enableSnap() {
    ...
    ;((this.#f = new py({ source: this.#t, intersection: !0 })), this.#n?.addInteraction(this.#f))
  }
  removeFeatures(t) {
    if (t == null) {
  ...
  #A() {
    const t = i => {
      const s = i.element,
        ...
        [o] = this.#i([s]),
        a = this.#i(r)
      this.dispatchEvent(new Ky(Qt.SELECT, a, o, r, []))
    }
    this.#e.on('add', t)
    const e = i => {
      const s = i.element,
        ...
        a = this.#i([s]),
        l = [s]
      this.dispatchEvent(new $y(Qt.DESELECT, a, r, o, l))
    }
    this.#e.on('remove', e)
  }
  #F() {
...
const a1 = 'LINESTRING(106.55773424492708 26.68974989181626,106.79592190619702 26.712142565234185)',
  l1 =
...
const d1 = [106.675271, 26.579508],
  f1 = Cd(d1),
  g1 = new og({
    target: 'ol-geom-editor-map',
    layers: [new bg({ source: new Dg() })],
    view: new te({ center: f1, zoom: 10 }),
  }),
  _1 = {
...
document.querySelector('#add-wkt').addEventListener('click', m1)
document.querySelector('#add-JSON').addEventListener('click', y1)
document.querySelector('#add-JSONObj').addEventListener('click', p1)
document.querySelector('#remove-feature').addEventListener('click', x1)
document.querySelector('#remove-selected-features').addEventListener('click', E1)
document.querySelector('#remove-all-features').addEventListener('click', C1)
document.querySelector('#select-features').addEventListener('click', R1)
document.querySelector('#deselect-features').addEventListener('click', w1)
document.querySelector('#enable-select').addEventListener('click', T1)
document.querySelector('#enable-select-single').addEventListener('click', S1)
document.querySelector('#disable-select').addEventListener('click', v1)
document.querySelector('#translate-features').addEventListener('click', I1)
document.querySelector('#disable-translate').addEventListener('click', M1)
document.querySelector('#enable-modify').addEventListener('click', P1)
document.querySelector('#disable-modify').addEventListener('click', b1)
document.querySelector('#select-type').addEventListener('change', F1)
document.querySelector('#freehand').addEventListener('change', O1)
function m1() {
  ;(console.log('addWKT'), k.addFeatureFromWKT(a1, 'line1'), k.addFeatureFromWKT(l1))
}
function y1() {
  ;(console.log('addJSON'), k.addFeatureFromJSON(c1))
}
function p1() {
  ;(console.log('addJSONObj'), k.addFeatureFromJSON(h1), k.addFeatureFromJSON(u1))
}
function E1() {
  k.removeFeatures()
}
