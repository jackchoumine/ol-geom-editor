...
let ju = 0
function wt(n) {
  return n.ol_uid || (n.ol_uid = String(++ju))
}
let Xa = class extends Ze {
  ...
  Re = class extends zn {
    ...
    notify(t, e) {
      let i
      ;((i = `change:${t}`),
        this.hasListener(i) && this.dispatchEvent(new Xa(i, t, e)),
        (i = Sn.PROPERTYCHANGE),
        this.hasListener(i) && this.dispatchEvent(new Xa(i, t, e)))
    }
...
const jt = { ADD: 'add', REMOVE: 'remove' },
  za = { LENGTH: 'length' }
  ...
  me = class extends Re {
    ...
    insertAt(t, e) {
      ...
      ;(this.unique_ && this.assertUnique_(e),
        ...
        this.updateLength_(),
        this.dispatchEvent(new ls(jt.ADD, e, t)))
    }
    pop() {
    ...
    removeAt(t) {
      ...
      return (this.array_.splice(t, 1), this.updateLength_(), this.dispatchEvent(new ls(jt.REMOVE, e, t)), e)
    }
    setAt(t, e) {
      ...
      ;((this.array_[t] = e),
        this.dispatchEvent(new ls(jt.REMOVE, s, t)),
        this.dispatchEvent(new ls(jt.ADD, e, t)))
    }
    updateLength_() {
    ...
    assertUnique_(t, e) {
      for (let i = 0, s = this.array_.length; i < s; ++i)
        if (this.array_[i] === t && i !== e) throw new Eh(58)
    }
  }
function $(n, t) {
  if (!n) throw new Eh(t)
...
function cs(n, t) {
  return Math.floor(bh(n, t))
}
function us(n, t) {
  return Math.ceil(bh(n, t))
}
function fd(n, t) {
...
function $a(n, t, e, i) {
  ...
  if (r) s = r(t, e)
    ...
    if ((o == 'degrees' && !i) || i == 'degrees') s = t
      ...
      const a = Uo(n, qt('EPSG:4326'))
      if (a === Fh && o !== 'degrees') s = t * n.getMetersPerUnit()
      else {
...
function Cd(n, t) {
  return (Ah(), Oh(n, 'EPSG:4326', 'EPSG:3857'))
}
function bi(n, t) {
  if (n === t) return !0
...
function wd() {
  ;(qa(Va), qa(Za), xd(Za, Va, nd, sd))
}
wd()
function Td(n, t, e, i, s, r) {
  r = r || []
  let o = 0
  for (let a = t; a < e; a += i) {
    const l = n[a],
          ...
          i.getUnits() == 'tile-pixels'
            ? function (r, o, a) {
                const l = i.getExtent(),
                  h = i.getWorldExtent(),
                  c = oe(h) / oe(l)
                return (vn(Ha, h[0], h[3], c, -c, 0, 0, 0), Td(r, 0, r.length, a, Ha, o), Us(i, e)(r, o, a))
              }
            : Us(i, e)
...
function Ld(n, t, e, i, s, r, o, a, l, h, c) {
  c = c || [NaN, NaN]
...
function Dd(n, t, e, i, s, r, o) {
  ...
  ;((t += i), (r[o++] = a), (r[o++] = l))
  let h, c
  do if (((h = wi(n[t], s)), (c = wi(n[t + 1], s)), (t += i), t == e)) return ((r[o++] = h), (r[o++] = c), o)
  while (h == a && c == l)
  for (; t < e; ) {
    const u = wi(n[t], s),
      d = wi(n[t + 1], s)
...
function zd(n, t, e, i, s, r, o) {
  ...
  for (_.sort(Go), c = _[0], a = 1, l = _.length; a < l; ++a) {
    ...
    ;(p > y && ((h = (c + u) / 2), zh(n, t, e, i, h, g) && ((m = h), (y = p))), (c = u))
  }
...
function Yd(n, t, e, i, s) {
  ...
  for (let r = 1, o = e.length; r < o; ++r)
    if (Xd(n, e[r - 1], e[r], i, s) && !Wh(n, e[r - 1], e[r], i, s)) return !1
  return !0
}
function Bd(n, t, e, i) {
  for (; t < e - i; ) {
...
let Vh = class go extends Zo {
  ...
  closestPointXY(t, e, i, s) {
    return s < Sh(this.getExtent(), t, e)
      ? s
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ((this.maxDelta_ = Math.sqrt(bd(this.flatCoordinates, 0, this.ends_, this.stride, 0))),
          (this.maxDeltaRevision_ = this.getRevision())),
        Ld(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !0, t, e, i, s))
  }
  containsXY(t, e) {
  ...
  getInteriorPoint() {
    return new jd(this.getFlatInteriorPoint(), 'XYM')
  }
  getLinearRingCount() {
  ...
  setCoordinates(t, e) {
    ...
    const i = Fd(this.flatCoordinates, 0, t, this.stride, this.ends_)
...
let te = class extends Re {
  ...
  getState() {
    ...
    if (r) {
      ...
      s = Fr(s, this.getViewportSize_(), [o[0] / 2 + r[3], o[1] / 2 + r[0]], e, i)
    }
    return {
      center: s.slice(0),
  ...
  getZoomForResolution(t) {
    ...
    if (this.resolutions_) {
      const r = jo(this.resolutions_, t, 1)
      ;((e = r),
  ...
  centerOnInternal(t, e, i) {
    this.setCenterInternal(Fr(t, e, i, this.getResolution(), this.getRotation()))
  }
  calculateCenterShift(t, e, i, s) {
    ...
    if (o && t) {
      const a = this.getViewportSizeMinusPadding_(-i),
        l = Fr(t, s, [a[0] / 2 + o[3], a[1] / 2 + o[0]], e, i)
      r = [t[0] - l[0], t[1] - l[1]]
    }
    return r
  }
...
function Ef(n) {
  let t,
    e,
    i,
    o = n.minZoom !== void 0 ? n.minZoom : Ar,
  ...
  if ((!h && !_ && d.isGlobal() && ((g = !1), (_ = f)), n.resolutions !== void 0)) {
    ...
    const y = (f ? Math.max(ot(f), oe(f)) : (360 * Wo.degrees) / d.getMetersPerUnit()) / qo / Math.pow(2, Ar),
      p = y / Math.pow(2, 28 - Ar)
    ;((e = n.maxResolution),
...
let Tf = class extends zn {
  ...
  Li = null
function Sf() {
  Li = We(1, 1, void 0, { willReadFrequently: !0 })
}
let vf = class extends Tf {
    ...
    getImageData(t, e, i) {
      ;(Li || Sf(), Li.clearRect(0, 0, 1, 1))
      let s
      try {
        ;(Li.drawImage(t, e, i, 1, 1, 0, 0, 1, 1), (s = Li.getImageData(0, 0, 1, 1).data))
      } catch {
        return ((Li = null), null)
      }
      return s
    ...
    preRender(t, e) {
      ;((this.frameState = e), this.dispatchRenderEvent_(je.PRERENDER, t, e))
    }
    postRender(t, e) {
      this.dispatchRenderEvent_(je.POSTRENDER, t, e)
    }
...
class nc extends Xo {
  ...
  setState(t) {
    if (this.state !== b.ERROR && this.state > t) throw new Error('Tile load sequence violation')
...
class sc extends nc {
  ...
  handleImageError_() {
    ;((this.state = b.ERROR), this.unlistenImage_(), (this.image_ = Mf()), this.changed())
  }
  handleImageLoad_() {
    const t = this.image_
    ;(t.naturalWidth && t.naturalHeight ? (this.state = b.LOADED) : (this.state = b.EMPTY),
      this.unlistenImage_(),
      this.changed())
  }
  load() {
  ...
  forEachFeatureAtCoordinate(t, e, i, s, r, o, a, l) {
    ...
    for (let x = 0; x < g.length; x++)
      for (let C = m - 1; C >= 0; --C) {
        const w = _[C],
          v = w.layer
        if (v.hasRenderer() && ea(w, c) && a.call(l, v)) {
          const S = v.getRenderer(),
            P = v.getSource()
          if (S && P) {
            const F = P.getWrapX() ? f : t,
              j = u.bind(null, w.managed)
            ;((p[0] = F[0] + g[x][0]),
              (p[1] = F[1] + g[x][1]),
              (h = S.forEachFeatureAtCoordinate(p, e, i, j, y)))
          }
          if (h) return h
        }
      }
    ...
    const E = 1 / y.length
    return (
      y.forEach((x, C) => (x.distanceSq += C * E)),
      y.sort((x, C) => x.distanceSq - C.distanceSq),
      y.some(x => (h = x.callback(x.feature, x.layer, x.geometry))),
      h
    )
  }
  hasFeatureAtCoordinate(t, e, i, s, r, o) {
    return this.forEachFeatureAtCoordinate(t, e, i, s, zs, this, r, o) !== void 0
  }
  getMap() {
    return this.map_
  }
...
class Af extends bf {
  ...
  renderFrame(t) {
    ...
    ;(this.calculateMatrices2D(t), this.dispatchRenderEvent(je.PRECOMPOSE, t))
    ...
    ;(this.flushDeclutterItems(t),
      ...
      this.dispatchRenderEvent(je.POSTCOMPOSE, t),
...
class an extends Qh {
  ...
  handleLayersChanged_() {
    ...
    this.layersListenerKeys_.push(
      U(t, jt.ADD, this.handleLayersAdd_, this),
      U(t, jt.REMOVE, this.handleLayersRemove_, this),
    )
...
class Ff extends Xo {
  constructor(t, e) {
    ...
    ;((this.activePointers_ = []),
      ...
      this.element_.addEventListener(G.TOUCHMOVE, this.boundHandleTouchMove_, wh ? { passive: !1 } : !1))
  }
  emulateClick_(t) {
    ...
    ;(this.dispatchEvent(e),
      this.clickTimeoutId_ !== void 0
        ...
        : (this.clickTimeoutId_ = setTimeout(() => {
            this.clickTimeoutId_ = void 0
            const i = new Fe(Q.SINGLECLICK, this.map_, t)
...
class Df extends Of {
  ...
  handleTileChange(t) {
    ...
    if (i === b.LOADED || i === b.ERROR || i === b.EMPTY) {
      i !== b.ERROR && e.removeEventListener(G.CHANGE, this.boundHandleTileChange_)
      const s = e.getKey()
...
function Xf(n) {
  ...
  const t = new me()
  return (
    (n.zoom !== void 0 ? n.zoom : !0) && t.push(new jf(n.zoomOptions)),
...
const Yf = function (n) {
  ...
  oc = function (n) {
    const t = n.originalEvent
    return t.button == 0 && !(Wu && xh && t.ctrlKey)
  },
  ac = function (n) {
    const t = n.originalEvent
    return !t.altKey && !(t.metaKey || t.ctrlKey) && !t.shiftKey
  ...
  handleEvent(t) {
    ...
    if (t.type == G.KEYDOWN) {
      ...
      if (this.condition_(t) && (s == He.DOWN || s == He.LEFT || s == He.RIGHT || s == He.UP)) {
        ...
        const c = [l, h]
        ;(Yo(c, o.getRotation()), zf(o, c, this.duration_), i.preventDefault(), (e = !0))
      }
    }
    return !e
  }
...
function rg(n) {
  ...
  return (
    (n.altShiftDragRotate !== void 0 ? n.altShiftDragRotate : !0) && t.push(new qf()),
...
let og = class extends Re {
  constructor(t) {
    ...
    ;(t.view &&
      ...
      this.controls.addEventListener(jt.ADD, s => {
        s.element.setMap(this)
      }),
      this.controls.addEventListener(jt.REMOVE, s => {
        s.element.setMap(null)
      }),
      this.interactions.addEventListener(jt.ADD, s => {
        s.element.setMap(this)
      }),
      this.interactions.addEventListener(jt.REMOVE, s => {
        s.element.setMap(null)
      }),
      this.overlays_.addEventListener(jt.ADD, s => {
        this.addOverlayInternal_(s.element)
      }),
      this.overlays_.addEventListener(jt.REMOVE, s => {
  ...
  forEachFeatureAtPixel(t, e, i) {
    ...
    const r = i.hitTolerance !== void 0 ? i.hitTolerance : 0,
      o = i.layerFilter !== void 0 ? i.layerFilter : zs,
      a = i.checkWrapped !== !1
  ...
  handlePostRender() {
    ...
    t &&
      ...
      (this.renderComplete_ === !0
        ? (this.hasListener(je.RENDERCOMPLETE) && this.renderer_.dispatchRenderEvent(je.RENDERCOMPLETE, t),
          this.loaded_ === !1 && ((this.loaded_ = !0), this.dispatchEvent(new Ai(Oe.LOADEND, this, t))))
        : this.loaded_ === !0 && ((this.loaded_ = !1), this.dispatchEvent(new Ai(Oe.LOADSTART, this, t))))
  ...
  handleTargetChanged_() {
    ...
    if (((this.targetElement_ = e), !e))
      ...
      ;(this.viewport_.addEventListener(G.CONTEXTMENU, this.boundHandleBrowserEvent_, !1),
        this.viewport_.addEventListener(G.WHEEL, this.boundHandleBrowserEvent_, wh ? { passive: !1 } : !1))
    ...
    ;((this.frameState_ = r),
      ...
      r &&
        ...
        s &&
          ...
          (this.dispatchEvent(new Ai(Oe.MOVESTART, this, s)),
        ...
        this.previousExtent_ &&
          ...
          (this.dispatchEvent(new Ai(Oe.MOVEEND, this, r)), Uu(r.extent, this.previousExtent_))),
      this.dispatchEvent(new Ai(Oe.POSTRENDER, this, r)),
      (this.renderComplete_ =
        this.hasListener(Oe.LOADSTART) || this.hasListener(Oe.LOADEND) || this.hasListener(je.RENDERCOMPLETE)
  ...
  constructor(t, e, i, s, r, o) {
    ...
    if ((this.addQuad_(h, c, u, d, f, g, _, m, y), this.wrapsXInSource_)) {
      ...
      ;(this.triangles_.forEach(function (E, x, C) {
        p = Math.min(p, E.source[0][0], E.source[1][0], E.source[2][0])
      }),
        this.triangles_.forEach(E => {
          if (Math.max(E.source[0][0], E.source[1][0], E.source[2][0]) - p > this.sourceWorldWidth_ / 2) {
            const x = [
              [E.source[0][0], E.source[0][1]],
              [E.source[1][0], E.source[1][1]],
              [E.source[2][0], E.source[2][1]],
            ]
            ;(x[0][0] - p > this.sourceWorldWidth_ / 2 && (x[0][0] -= this.sourceWorldWidth_),
              x[1][0] - p > this.sourceWorldWidth_ / 2 && (x[1][0] -= this.sourceWorldWidth_),
              x[2][0] - p > this.sourceWorldWidth_ / 2 && (x[2][0] -= this.sourceWorldWidth_))
  ...
  addQuad_(t, e, i, s, r, o, a, l, h) {
    ...
    if (h > 0) {
      if (this.targetProj_.isGlobal() && this.targetWorldWidth_) {
        const m = Ya([t, e, i, s])
        g = ot(m) / this.targetWorldWidth_ > xl || g
      }
      !f && this.sourceProj_.isGlobal() && u && (g = u > xl || g)
    }
    if (
      !g &&
    ...
    if (h > 0) {
      ...
      if (g) {
        if (Math.abs(t[0] - i[0]) <= Math.abs(t[1] - i[1])) {
          ...
          ;(this.addQuad_(t, e, m, p, r, o, y, E, h - 1), this.addQuad_(p, m, i, s, E, y, a, l, h - 1))
        } else {
          const m = [(t[0] + e[0]) / 2, (t[1] + e[1]) / 2],
            y = this.transformInv_(m),
            p = [(i[0] + s[0]) / 2, (i[1] + s[1]) / 2],
            E = this.transformInv_(p)
          ;(this.addQuad_(t, m, p, s, r, y, E, l, h - 1), this.addQuad_(m, e, i, p, y, o, a, E, h - 1))
        }
        return
      }
    }
...
function yg(n, t, e, i, s, r, o, a, l, h, c, u) {
  ...
  l.forEach(function (x, C, w) {
    ...
    x.image.width > 0 &&
      x.image.height > 0 &&
      y.drawImage(x.image, h, h, x.image.width - 2 * h, x.image.height - 2 * h, v * p, S * p, P * p, F * p)
  })
  const E = fi(o)
  return (
    a.getTriangles().forEach(function (x, C, w) {
      const v = x.source,
        S = x.target
      let P = v[0][0],
        F = v[0][1],
    ...
    c &&
      ...
      a.getTriangles().forEach(function (x, C, w) {
        const v = x.target,
          ...
          N = (v[2][0] - E[0]) / r,
          D = -(v[2][1] - E[1]) / r
        ;(d.beginPath(), d.moveTo(F, j), d.lineTo(S, P), d.lineTo(N, D), d.closePath(), d.stroke())
      }),
      d.restore()),
    d.canvas
  )
...
class Eo extends nc {
  constructor(t, e, i, s, r, o, a, l, h, c, u, d) {
    ...
    const x = c !== void 0 ? c : dg
    if (
      ((this.triangulation_ = new gg(t, i, m, _, E * x, p)), this.triangulation_.getTriangles().length === 0)
    ) {
      this.state = b.EMPTY
      return
    }
    ...
    if (
      ...
      const w = e.getTileRangeForExtentAndZ(C, this.sourceZ_)
      for (let v = w.minX; v <= w.maxX; v++)
        for (let S = w.minY; S <= w.maxY; S++) {
...
class pg extends vf {
  ...
  getTile(t, e, i, s) {
    ...
    return (
      h.getState() == b.ERROR && a.getUseInterimTilesOnError() && a.getPreload() > 0 && (this.newTiles_ = !0),
  ...
  getData(t) {
    ...
    for (let d = c.getZForResolution(l.resolution); d >= c.getMinZoom(); --d) {
      ...
      if (!(g instanceof sc || g instanceof Eo) || (g instanceof Eo && g.getState() === b.EMPTY)) return null
      if (g.getState() !== b.LOADED) continue
      const _ = c.getOrigin(d),
        m = ie(c.getTileSize(d)),
        y = c.getResolution(d),
        p = Math.floor(u * ((s[0] - _[0]) / y - f[1] * m[0])),
        E = Math.floor(u * ((_[1] - s[1]) / y - f[2] * m[1])),
        x = Math.round(u * h.getGutterForProjection(l.projection))
      return this.getImageData(g.getImage(), p + x, E + x)
    }
    return null
  }
  loadedTileCallback(t, e, i) {
  ...
  renderFrame(t, e) {
    ...
    const y = t.viewState.resolution,
      ...
      E = Math.round((ot(m) / y) * h),
      x = Math.round((oe(m) / y) * h),
      C = i.extent && Ni(i.extent)
    C && (m = Rn(m, Ni(i.extent)))
    const w = (_ * E) / 2 / p,
      v = (_ * x) / 2 / p,
      S = [a[0] - w, a[1] - v, a[0] + w, a[1] + v],
      P = f.getTileRangeForExtentAndZ(m, g),
      F = {}
    F[g] = {}
    const j = this.createLoadedTileFinder(u, r, F),
      N = this.tmpExtent,
    ...
    for (let It = P.minX; It <= P.maxX; ++It)
      for (let W = P.minY; W <= P.maxY; ++W) {
        ...
        if (this.isDrawableTile(q)) {
          const lt = wt(this)
          if (q.getState() == b.LOADED) {
            F[g][q.tileCoord.toString()] = q
            let le = q.inTransition(lt)
            ;(le && i.opacity !== 1 && (q.endTransition(lt), (le = !1)),
        ...
        let Jt = !1
        ;(Te && (Jt = j(g + 1, Te)), Jt || f.forEachTileCoordParentTileRange(q.tileCoord, j, D, N))
      }
    const I = ((_ / o) * h) / p
    vn(this.pixelTransform, t.size[0] / 2, t.size[1] / 2, 1 / h, 1 / h, l, -E / 2, -x / 2)
    ...
    ;(Th(this.inversePixelTransform, this.pixelTransform),
      vn(this.tempTransform, E / 2, x / 2, I, I, 0, -E / 2, -x / 2),
      O.width != E || O.height != x
        ? ((O.width = E), (O.height = x))
        : this.containerReused || T.clearRect(0, 0, E, x),
    ...
    for (let It = Z.length - 1; It >= 0; --It) {
      ...
      for (const cn in Se) {
        const ve = Se[cn],
          ...
          xt = Math.round(yi[0] - ns * lt),
          Ft = Math.round(yi[1] - pi * le),
          Bt = ss - xt,
          he = Mr - Ft,
          Ei = g === W,
          $e = Ei && ve.getAlpha(wt(this), t.time) !== 1
        let Ie = !1
        if (!$e)
          if (Y) {
            R = [xt, Ft, xt + Bt, Ft, xt + Bt, Ft + he, xt, Ft + he]
            for (let xi = 0, rs = Y.length; xi < rs; ++xi)
              if (g !== W && W < st[xi]) {
                const gt = Y[xi]
                Yn([xt, Ft, xt + Bt, Ft + he], [gt[0], gt[3], gt[4], gt[7]]) &&
                  (Ie || (T.save(), (Ie = !0)),
                  T.beginPath(),
                  T.moveTo(R[0], R[1]),
                  T.lineTo(R[2], R[3]),
            ...
            ;(Y.push(R), st.push(W))
          } else T.clearRect(xt, Ft, Bt, he)
        ;(this.drawTileImage(ve, t, xt, Ft, Bt, he, es, Ei),
  ...
  manageTilePyramid(t, e, i, s, r, o, a, l, h) {
    ...
    let m = 0,
      ...
      w
    for (w = f; w <= a; ++w)
      for (p = i.getTileRangeForExtentAndZ(o, w, p), E = i.getResolution(w), x = p.minX; x <= p.maxX; ++x)
        for (C = p.minY; C <= p.maxY; ++C)
          (g && !i.tileCoordIntersectsViewport([w, x, C], _)) ||
            (a - w <= l
              ? (++m,
                (y = e.getTile(w, x, C, s, r)),
                y.getState() == b.IDLE &&
                  ((u[y.getKey()] = !0),
                  d.isKeyQueued(y.getKey()) || d.enqueue([y, c, i.getTileCoordCenter(y.tileCoord), E])),
                h !== void 0 && h(y))
              : e.useTile(w, x, C, r))
...
class fc {
  ...
  forEachTileCoordParentTileRange(t, e, i, s) {
    ...
    for (
      ...
      if (
        (this.zoomFactor_ === 2
          ? ((o = Math.floor(o / 2)), (a = Math.floor(a / 2)), (r = Ti(o, o, a, a, i)))
  ...
  getTileRangeForTileCoordAndZ(t, e, i) {
    ...
    const s = t[0],
      r = t[1],
      o = t[2]
    if (e === s) return Ti(r, o, r, o, i)
    if (this.zoomFactor_) {
      const l = Math.pow(this.zoomFactor_, e - s),
        h = Math.floor(r * l),
        c = Math.floor(o * l)
      if (e < s) return Ti(h, h, c, c, i)
  ...
  getZForResolution(t, e) {
    const i = jo(this.resolutions_, t, e || 0)
...
const jr = { TILELOADSTART: 'tileloadstart', TILELOADEND: 'tileloadend', TILELOADERROR: 'tileloaderror' }
function gc(n) {
...
function _c(n, t, e, i) {
  ;((t = t !== void 0 ? t : cf), (e = ie(e !== void 0 ? e : qo)))
  const s = oe(n),
    r = ot(n)
...
class wg extends If {
  ...
  forEachLoadedTile(t, e, i, s) {
    ...
    for (let c = i.minX; c <= i.maxX; ++c)
      for (let u = i.minY; u <= i.maxY; ++u)
        ((l = Er(e, c, u)),
          (h = !1),
          r.containsKey(l) && ((a = r.get(l)), (h = a.getState() === b.LOADED), h && (h = s(a) !== !1)),
          h || (o = !1))
    return o
  }
  ...
  getTileCacheForProjection(t) {
    ...
    return ($(e === null || bi(e, t), 68), this.tileCache)
  }
  getTilePixelRatio(t) {
  ...
  getTileCoordForTileUrlFunction(t, e) {
    ...
    return (this.getWrapX() && e.isGlobal() && (t = Eg(i, t, e)), ug(t, i) ? t : null)
  }
  clear() {
...
class aa extends wg {
  ...
  handleTileChange(t) {
    ...
    let r
    ;(s == b.LOADING
      ? ((this.tileLoadingKeys_[i] = !0), (r = jr.TILELOADSTART))
      : i in this.tileLoadingKeys_ &&
        (delete this.tileLoadingKeys_[i],
        (r = s == b.ERROR ? jr.TILELOADERROR : s == b.LOADED ? jr.TILELOADEND : void 0)),
...
class Lg extends aa {
  ...
  getGutterForProjection(t) {
    return this.getProjection() && t && !bi(this.getProjection(), t) ? 0 : this.getGutter()
  }
  getGutter() {
    return 0
  }
  ...
  getOpaque(t) {
    return this.getProjection() && t && !bi(this.getProjection(), t) ? !1 : super.getOpaque(t)
  }
  getTileGridForProjection(t) {
    const e = this.getProjection()
    if (this.tileGrid && (!e || bi(e, t))) return this.tileGrid
    const i = wt(t)
    return (
  ...
  getTileCacheForProjection(t) {
    const e = this.getProjection()
    if (!e || bi(e, t)) return this.tileCache
    const i = wt(t)
    return (
  ...
  getTile(t, e, i, s, r) {
    ...
    if (!o || !r || bi(o, r)) return this.getTileInternal(t, e, i, s, o || r)
    ...
    const d = this.getTileGridForProjection(o),
      ...
      _ = new Eo(
        ...
        this.getGutter(),
        (m, y, p, E) => this.getTileInternal(m, y, p, E, o),
  ...
  getTileInternal(t, e, i, s, r) {
    ...
    if (!this.tileCache.containsKey(a)) ((o = this.createTile_(t, e, i, s, r, l)), this.tileCache.set(a, o))
      ...
      ;((o = this.createTile_(t, e, i, s, r, l)),
        h.getState() == b.IDLE ? (o.interimTile = h.interimTile) : (o.interimTile = h),
...
const kg = {},
  Ng = `<h1>ol-geom-editor</h1>
<p>An elegant OpenLayers extension for editing geometric shapes.</p>
<h2>Usage</h2>
<h3>install</h3>
<blockquote>
<p>in node</p>
</blockquote>
<pre><code class="language-bash">npm i ol-geom-editor
</code></pre>
<p>then</p>
<pre><code class="language-js">import { GeomEditor } from olGeomEditor
...
<pre><code class="language-html">&lt;script src=&quot;https://unpkg.com/ol-geom-editor&quot;&gt;&lt;/script&gt;
</code></pre>
<p>then</p>
<pre><code class="language-js">const { GeomEditor } = olGeomEditor

const geomEditor = new GeomEditor(olMap) // pass ol map instance
</code></pre>
<h2>create a geomEditor instance</h2>
<p>GeomEditor has two params:</p>
<pre><code class="language-js">const geomEditor = new GeomEditor(olMapInstance, options)
</code></pre>
...
<pre><code class="language-js">import { Circle as CircleStyle, Fill, Stroke, Style } from 'ol/style'
...
<h4>examples</h4>
<pre><code class="language-js">const lineWKT = 'LINESTRING(106.55773424492708 26.68974989181626,106.79592190619702 26.712142565234185)'
...
<h4>examples</h4>
<pre><code class="language-ts">const fillColor = 'rgba(218,228,194,0.5)'
...
<h3>examples</h3>
<pre><code class="language-ts">geomEditor.deselect(['line1', 'p2CQqn2lFk'])
</code></pre>
...
<h4>examples</h4>
<pre><code class="language-ts">geomEditor.removeFeatures() // remove all selected features
...
<h2>events</h2>
<p>GeomEditor emit some events when interact with features.</p>
<blockquote>
<p>GeomEditor emit custom events and emit ol interaction event.</p>
</blockquote>
<blockquote>
...
<blockquote>
<p>all event emit soma data you can use directly and align with the original event.</p>
</blockquote>
<p>event list:</p>
<table>
<thead>
...
<blockquote>
<p>The original event will also be triggered at the time of response.</p>
</blockquote>
<h3>examples</h3>
<pre><code class="language-js">// original event
...
let Yg = 0
function K(n) {
  return n.ol_uid || (n.ol_uid = String(++Yg))
}
class wl extends Et {
  constructor(t, e, i) {
    ;(super(t), (this.key = e), (this.oldValue = i))
...
class we extends Zn {
  ...
  notify(t, e) {
    let i
    ;((i = `change:${t}`),
      this.hasListener(i) && this.dispatchEvent(new wl(i, t, e)),
      (i = yc.PROPERTYCHANGE),
      this.hasListener(i) && this.dispatchEvent(new wl(i, t, e)))
  }
  addChangeListener(t, e) {
...
class pt extends we {
  ...
  setStyle(t) {
    ;((this.style_ = t), (this.styleFunction_ = t ? Bg(t) : void 0), this.changed())
  }
  setId(t) {
...
function bt(n) {
  const t = ae()
  for (let e = 0, i = n.length; e < i; ++e) wc(t, n[e])
  return t
}
function Kn(n, t, e) {
  return e
...
function Kg(n, t, e, i, s) {
  const [r, o, a, l, h, c, u, d] = $g(n, t, e, i)
...
function Jg(n, t) {
  if (t.canWrapX()) {
    ...
    Lc(n, t)
    const i = zt(e)
    if (zt(n) > i) return [[e[0], n[1], e[2], n[3]]]
    if (n[0] < e[0])
      return [
        [n[0] + i, n[1], e[2], n[3]],
        [e[0], n[1], n[2], n[3]],
...
function i_(n, t, e) {
  ...
  ;((e = e > 1 ? e : 2), t === void 0 && (e > 2 ? (t = n.slice()) : (t = new Array(i))))
  for (let s = 0; s < i; s += e)
    ((t[s] = (180 * n[s]) / ji), (t[s + 1] = (360 * Math.atan(Math.exp(n[s + 1] / $n))) / Math.PI - 90))
  return t
}
const n_ = 6378137,
  vl = [-180, -90, 180, 90],
...
function g_(n, t, e) {
  ...
  let s = 0
  return (
    t.canWrapX() && (n[0] < i[0] || n[0] > i[2]) && ((e = e || zt(i)), (s = Math.floor((n[0] - i[0]) / e))),
    s
  )
}
...
function p_(n) {
  ;(o_(n.getCode(), n), $s(n, n, fa))
}
function E_(n) {
  n.forEach(p_)
}
function vt(n) {
  return typeof n == 'string' ? r_(n) : n || null
}
function Pl(n) {
  ;(E_(n),
    n.forEach(function (t) {
...
function ps(n, t) {
  const e = ei(n, 'EPSG:3857', 'EPSG:4326'),
    i = e[0]
  return ((i < -180 || i > 180) && (e[0] = qs(i + 180, 360) - 180), e)
}
function C_(n, t) {
  if (n === t) return !0
  const e = n.getUnits() === t.getUnits()
...
function ei(n, t, e) {
  return wo(t, e)(n, void 0, n.length)
}
function nn(n, t) {
  return n
}
function J(n, t) {
  return (
    Ro &&
      ...
      n[1] <= 90 &&
      ((Ro = !1),
      m_('Call useGeographic() from ol/proj once to work with [longitude, latitude] coordinates.')),
    n
  )
}
function xr(n, t) {
...
function Js(n, t, e) {
  ...
  let r
  if (
    (i && s && !C_(i, s) ? (r = (t ? n.clone() : n).transform(t ? i : s, t ? s : i)) : (r = n),
...
class w_ extends jc {
  ...
  readFeature(t, e) {
    return this.readFeatureFromObject(Es(t), this.getReadOptions(t, e))
  }
  readFeatures(t, e) {
    return this.readFeaturesFromObject(Es(t), this.getReadOptions(t, e))
  }
  ...
  readGeometry(t, e) {
    return this.readGeometryFromObject(Es(t), this.getReadOptions(t, e))
  }
  readGeometryFromObject(t, e) {
    return L()
  }
  readProjection(t) {
    return this.readProjectionFromObject(Es(t))
  }
...
Ye.includes('firefox')
const T_ = Ye.includes('safari') && !Ye.includes('chrom')
T_ && (Ye.includes('version/15.4') || /cpu (os|iphone os) 15_4 like mac os x/.test(Ye))
...
const _a =
  ...
  S_ = typeof Image < 'u' && Image.prototype.decode
;(function () {
  let n = !1
  try {
    const t = Object.defineProperty({}, 'passive', {
...
function M_(n, t, e) {
  return v_(n, t, 0, 0, e, 0, 0)
}
function qn(n, t, e, i, s, r, o, a) {
  const l = Math.sin(r),
    h = Math.cos(r)
  return (
    (n[0] = i * h),
...
class Xc extends we {
  constructor() {
    ;(super(),
      ...
      (this.simplifiedGeometryMaxMinSquaredTolerance = 0),
      (this.simplifiedGeometryRevision = 0),
      (this.simplifyTransformedInternal = Wg(function (t, e, i) {
        if (!i) return this.getSimplifiedGeometry(e)
        const s = this.clone()
        return (s.applyTransform(i), s.getSimplifiedGeometry(e))
      })))
        ...
        i.getUnits() == 'tile-pixels'
          ? function (r, o, a) {
              const l = i.getExtent(),
                h = i.getWorldExtent(),
                c = bn(h) / bn(l)
              return (qn(Ll, h[0], h[3], c, -c, 0, 0, 0), ai(r, 0, r.length, a, Ll, o), wo(i, e)(r, o, a))
            }
          : wo(i, e)
    return (this.applyTransform(s), this)
  }
...
class Ke extends Xc {
  ...
  scale(t, e, i) {
    ...
    if (s) {
      const r = this.getStride()
      ;(A_(s, 0, s.length, r, t, e, i, s), this.changed())
    }
  }
  translate(t, e) {
    const i = this.getFlatCoordinates()
    if (i) {
      const s = this.getStride()
      ;(F_(i, 0, i.length, s, t, e, i), this.changed())
    }
  }
}
function O_(n) {
...
function Al(n, t, e, i, s, r, o) {
  ...
  if (h === 0 && c === 0) u = t
    ...
    if (d > 1) u = e
      ...
      for (let f = 0; f < i; ++f) o[f] = Lt(n[t + f], n[e + f], d)
      o.length = i
      return
    } else u = t
  }
...
function Ea(n, t, e, i, s, r, o, a, l, h, c) {
  ...
  let f = t + i
  for (; f < e; )
    if ((Al(n, f - i, f, i, o, a, c), (d = ye(o, a, c[0], c[1])), d < h)) {
      for (h = d, u = 0; u < i; ++u) l[u] = c[u]
      ;((l.length = i), (f += i))
    } else f += i * Math.max(((Math.sqrt(d) - Math.sqrt(h)) / s) | 0, 1)
  if (r && (Al(n, e - i, t, i, o, a, c), (d = ye(o, a, c[0], c[1])), d < h)) {
    for (h = d, u = 0; u < i; ++u) l[u] = c[u]
    l.length = i
  }
  return h
...
function xa(n, t, e, i, s, r, o, a, l, h, c) {
  ...
  for (let u = 0, d = e.length; u < d; ++u) {
    const f = e[u]
    ;((h = Ea(n, t, f, i, s, r, o, a, l, h, c)), (t = f))
  }
  return h
}
function N_(n, t, e, i, s, r, o, a, l, h, c) {
  c = c || [NaN, NaN]
  for (let u = 0, d = e.length; u < d; ++u) {
    const f = e[u]
    ;((h = xa(n, t, f, i, s, r, o, a, l, h, c)), (t = f[f.length - 1]))
  }
  return h
}
function zc(n, t, e, i) {
...
function Wc(n, t, e, i, s, r, o, a) {
  for (let l = 0, h = e.length; l < h; ++l) {
    const c = e[l]
    ;((o = X_(n, t, c, i, s, r, o)), a.push(o), (t = c))
  }
  return o
}
function z_(n, t, e, i, s, r, o, a) {
  for (let l = 0, h = e.length; l < h; ++l) {
    const c = e[l],
      u = []
...
function To(n, t, e, i, s) {
  ...
  for (let o = 0, a = e.length; o < a; ++o) {
    const l = e[o]
    ;((s[r++] = l.length === 1 && l[0] === t ? [] : Ln(n, t, l, i, s[r])), (t = l[l.length - 1]))
  }
  return ((s.length = r), s)
}
function Bc(n, t, e, i, s, r, o) {
  ...
  for (let c = 0; c < o; ++c)
    r[c] = a === void 0 ? NaN : l === void 0 ? n[a + c] : Lt(n[a + c], n[a + i + c], l)
  return r
}
function So(n, t, e, i, s, r) {
  ...
  const c = n[(a + 1) * i - 1],
    u = (s - h) / (c - h)
  o = []
  for (let d = 0; d < i - 1; ++d) o.push(Lt(n[(a - 1) * i + d], n[a * i + d], u))
  return (o.push(s), o)
}
...
function Vc(n, t, e, i, s) {
  if (!U_(n, t, e[0], i, s)) return !1
  if (e.length === 1) return !0
  for (let r = 1, o = e.length; r < o; ++r)
    if (Y_(n, e[r - 1], e[r], i, s) && !Rr(n, e[r - 1], e[r], i, s)) return !1
  return !0
}
  ...
  closestPointXY(t, e, i, s) {
    return s < _i(this.getExtent(), t, e)
      ...
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ...
          (this.maxDeltaRevision_ = this.getRevision())),
        Ea(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, this.maxDelta_, !1, t, e, i, s))
  }
  forEachSegment(t) {
...
class An extends Ke {
  ...
  clone() {
    return new An(this.flatCoordinates.slice(), this.layout)
  }
  closestPointXY(t, e, i, s) {
    return s < _i(this.getExtent(), t, e)
      ? s
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ...
          (this.maxDeltaRevision_ = this.getRevision())),
        Ea(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, this.maxDelta_, !0, t, e, i, s))
  }
  getArea() {
...
class ci extends Ke {
  ...
  closestPointXY(t, e, i, s) {
    return s < _i(this.getExtent(), t, e)
      ...
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ...
          (this.maxDeltaRevision_ = this.getRevision())),
        xa(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !1, t, e, i, s))
  }
  getCoordinateAtM(t, e, i) {
    return (this.layout != 'XYM' && this.layout != 'XYZM') || this.flatCoordinates.length === 0
      ...
      : ((e = e !== void 0 ? e : !1),
        (i = i !== void 0 ? i : !1),
        W_(this.flatCoordinates, 0, this.ends_, this.stride, t, e, i))
  }
  getCoordinates() {
  ...
  getSimplifiedGeometryInternal(t) {
    const e = [],
      i = []
    return ((e.length = j_(this.flatCoordinates, 0, this.ends_, this.stride, t, e, 0, i)), new ci(e, 'XY', i))
  }
  getType() {
    return 'MultiLineString'
  }
  intersectsExtent(t) {
    return V_(this.flatCoordinates, 0, this.ends_, this.stride, t)
  }
  setCoordinates(t, e) {
    ;(this.setLayout(e, t, 2), this.flatCoordinates || (this.flatCoordinates = []))
...
function $c(n, t, e, i, s, r, o) {
  ...
  for (_.sort(Mn), c = _[0], a = 1, l = _.length; a < l; ++a) {
    u = _[a]
    const p = Math.abs(u - c)
    ;(p > y && ((h = (c + u) / 2), wa(n, t, e, i, h, g) && ((m = h), (y = p))), (c = u))
  }
...
function H_(n, t, e, i, s) {
  for (let r = 0, o = e.length; r < o; ++r) {
    const a = e[r]
    if (!Hc(n, t, a, i, s)) return !1
...
function vo(n, t, e, i, s) {
  ...
  for (let r = 0, o = e.length; r < o; ++r) {
    const a = e[r],
      l = qc(n, t, a, i)
    ;((r === 0 ? (s && l) || (!s && !l) : (s && !l) || (!s && l)) && q_(n, t, a, i), (t = a))
  }
  return t
}
...
class Yt extends Ke {
  ...
  closestPointXY(t, e, i, s) {
    return s < _i(this.getExtent(), t, e)
      ...
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ((this.maxDelta_ = Math.sqrt(pa(this.flatCoordinates, 0, this.ends_, this.stride, 0))),
          (this.maxDeltaRevision_ = this.getRevision())),
        xa(this.flatCoordinates, 0, this.ends_, this.stride, this.maxDelta_, !0, t, e, i, s))
  }
  containsXY(t, e) {
    return wa(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, t, e)
  }
  getArea() {
  ...
  getLinearRing(t) {
    return t < 0 || this.ends_.length <= t
      ? null
      : new An(this.flatCoordinates.slice(t === 0 ? 0 : this.ends_[t - 1], this.ends_[t]), this.layout)
  }
  getLinearRings() {
    const t = this.layout,
      e = this.flatCoordinates,
...
function J_(n, t, e, i) {
  e = e || 32
  const s = []
  for (let r = 0; r < e; ++r) re(s, __(n, t, (2 * Math.PI * r) / e, i))
  return (s.push(s[0], s[1]), new Yt(s, 'XY', [s.length]))
}
function Ol(n) {
  if (bc(n)) throw new Error('Cannot create polygon from empty extent')
  const t = n[0],
    e = n[1],
    i = n[2],
    s = n[3],
...
function em(n, t, e, i) {
  ...
  for (let o = 0, a = e.length; o < a; ++o) {
    const l = e[o]
    ;((r = xc(n, t, l[0], i)), s.push((r[0] + r[2]) / 2, (r[1] + r[3]) / 2), (t = l[l.length - 1]))
  }
  return s
}
class ui extends Ke {
  ...
  closestPointXY(t, e, i, s) {
    return s < _i(this.getExtent(), t, e)
      ? s
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ((this.maxDelta_ = Math.sqrt(k_(this.flatCoordinates, 0, this.endss_, this.stride, 0))),
          (this.maxDeltaRevision_ = this.getRevision())),
        N_(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, this.maxDelta_, !0, t, e, i, s))
  }
  containsXY(t, e) {
    return B_(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, t, e)
  }
  getArea() {
    return K_(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride)
  }
  getCoordinates(t) {
    let e
    return (
  ...
  getFlatInteriorPoints() {
    if (this.flatInteriorPointsRevision_ != this.getRevision()) {
      const t = em(this.flatCoordinates, 0, this.endss_, this.stride)
      ;((this.flatInteriorPoints_ = $_(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, t)),
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      const t = this.flatCoordinates
      ;(H_(t, 0, this.endss_, this.stride)
        ? (this.orientedFlatCoordinates_ = t)
        : ((this.orientedFlatCoordinates_ = t.slice()),
  ...
  getSimplifiedGeometryInternal(t) {
    const e = [],
      i = []
    return (
      (e.length = z_(this.flatCoordinates, 0, this.endss_, this.stride, Math.sqrt(t), e, 0, i)),
      new ui(e, 'XY', i)
    )
  }
  getPolygon(t) {
  ...
  intersectsExtent(t) {
    return Z_(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, t)
  }
  setCoordinates(t, e) {
    ;(this.setLayout(e, t, 3), this.flatCoordinates || (this.flatCoordinates = []))
    const i = G_(this.flatCoordinates, 0, t, this.stride, this.endss_)
...
class mm extends jc {
  ...
  readFeature(t, e) {
    return this.readFeatureFromText(xs(t), this.adaptOptions(e))
  }
  readFeatureFromText(t, e) {
    return L()
  }
  readFeatures(t, e) {
    return this.readFeaturesFromText(xs(t), this.adaptOptions(e))
  }
  readFeaturesFromText(t, e) {
    return L()
  }
  readGeometry(t, e) {
    return this.readGeometryFromText(xs(t), this.adaptOptions(e))
  }
  readGeometryFromText(t, e) {
    return L()
  }
  readProjection(t) {
    return this.readProjectionFromText(xs(t))
  }
...
const ym = /^#([a-f0-9]{3}|[a-f0-9]{4}(?:[a-f0-9]{2}){0,2})$/i,
  pm = /^([a-z]*)$|^hsla?\(.*\)$/i
function Jc(n) {
...
function er(n) {
  return Array.isArray(n) ? n : xm(n)
}
function Cm(n) {
  let t, e, i, s, r
  if ((pm.exec(n) && (n = Em(n)), ym.exec(n))) {
    const o = n.length - 1
    let a
    o <= 4 ? (a = 1) : (a = 2)
    const l = o === 4 || o === 8
...
class Sm extends Ec {
  ...
  isTainted_() {
    if (this.tainted_ === void 0 && this.imageState_ === tt.LOADED) {
      ;(mn || (mn = Ht(1, 1, void 0, { willReadFrequently: !0 })), mn.drawImage(this.image_, 0, 0))
      try {
  ...
  load() {
    if (this.imageState_ === tt.IDLE) {
      ...
      this.unlisten_ = Tm(this.image_, this.handleImageLoad_.bind(this), this.handleImageError_.bind(this))
    }
  }
  replaceColor_(t) {
...
function vm(n, t, e, i, s, r) {
  let o = Gl.get(t, i, r)
  return (o || ((o = new Sm(n, t, e, i, s, r)), Gl.set(t, i, r, o)), o)
}
function jl(n, t, e, i) {
      ...
      if (t.size) [h, c] = t.size
        ...
        if (u instanceof HTMLCanvasElement || (u.src && u.complete)) ((h = u.width), (c = u.height))
          ...
          const d = () => {
            ...
            this.setScale(jl(f[0], f[1], t.width, t.height))
          }
          this.listenImageChange(d)
          return
        }
      }
      h !== void 0 && this.setScale(jl(h, c, t.width, t.height))
    }
  }
  clone() {
    let t, e, i
...
`),
            ...
            ? (ha(bo), (Fi = null), (Po = void 0), Pe.set(f, 100))
...
function iu(n, t) {
  return (Fi || (Fi = Ht(1, 1)), n != Po && ((Fi.font = n), (Po = Fi.font)), Fi.measureText(t))
}
function sr(n, t) {
  return iu(n, t).width
}
...
function Lm(n, t, e, i, s, r, o, a, l, h, c) {
  ;(n.save(),
    e !== 1 && (n.globalAlpha *= e),
    t && n.setTransform.apply(n, t),
    i.contextInstructions
      ? (n.translate(l, h), n.scale(c[0], c[1]), Am(i, n))
      : c[0] < 0 || c[1] < 0
...
function Om(n, t) {
  if (!Xr) {
    const e = new Ve({ color: 'rgba(255,255,255,0.4)' }),
      i = new Ee({ color: '#3399CC', width: 1.25 })
    Xr = [new Kt({ image: new hn({ fill: e, stroke: i, radius: 5 }), fill: e, stroke: i })]
  }
  return Xr
}
function nu() {
  ...
  return (
    ...
    (n.LineString = [
      new Kt({ stroke: new Ee({ color: t, width: i + 2 }) }),
      new Kt({ stroke: new Ee({ color: e, width: i }) }),
    ]),
    ...
    (n.Point = [
      new Kt({
        image: new hn({
          radius: i * 2,
          fill: new Ve({ color: e }),
          stroke: new Ee({ color: t, width: i / 2 }),
        }),
        zIndex: 1 / 0,
      }),
    ]),
...
class Ta {
  constructor(t) {
    ;((t = t || {}),
      ...
      (this.fill_ = t.fill !== void 0 ? t.fill : new Ve({ color: Dm })),
...
const km = { POINT: Wt, LINESTRING: $t, POLYGON: Yt, MULTIPOINT: ln, MULTILINESTRING: ci, MULTIPOLYGON: ui },
  su = 'EMPTY',
  ru = 'Z',
  ou = 'M',
  Nm = 'ZM',
...
`
  ...
  nextToken() {
    ...
    else if (this.isNumeric_(t) || t == '-') ((s = z.NUMBER), (i = this.readNumber_()))
    else if (this.isAlpha_(t)) ((s = z.TEXT), (i = this.readText_()))
    else {
...
class Xm {
  ...
  parseGeometryLayout_() {
    ...
    if (this.isTokenType(z.TEXT)) {
      const i = e.value
      ;(i === ru ? (t = 'XYZ') : i === ou ? (t = 'XYM') : i === Nm && (t = 'XYZM'),
        t !== 'XY' && this.consume_())
    }
    return t
  }
...
class Ul extends we {
  constructor(t) {
    ;(super(),
      ...
      t.extent && (t.extent = Xi(t.extent, this.projection_)),
      this.applyOptions_(t))
  }
  applyOptions_(t) {
    const e = Object.assign({}, t)
  ...
  animateInternal(t) {
    ...
    for (; s < e; ++s) {
      ...
      ;(m0(u) ? (u.complete = !0) : (r += u.duration), h.push(u))
    }
  ...
  calculateCenterRotate(t, e) {
    let i
    const s = this.getCenterInternal()
    return (s !== void 0 && ((i = [s[0] - e[0], s[1] - e[1]]), u_(i, t - this.getRotation()), h_(i, e)), i)
  }
  calculateCenterZoom(t, e) {
    let i
    const s = this.getCenterInternal(),
  ...
  calculateExtent(t) {
    const e = this.calculateExtentInternal(t)
    return xr(e, this.getProjection())
  }
  calculateExtentInternal(t) {
    t = t || this.getViewportSizeMinusPadding_()
    const e = this.getCenterInternal()
    ...
    et(i !== void 0, 2)
    const s = this.getRotation()
    return (et(s !== void 0, 3), Kg(e, i, s, t))
  }
  getMaxResolution() {
    return this.maxResolution_
  }
  ...
  getResolutionForExtent(t, e) {
    return this.getResolutionForExtentInternal(Xi(t, this.getProjection()), e)
  }
  getResolutionForExtentInternal(t, e) {
    e = e || this.getViewportSizeMinusPadding_()
    const i = zt(t) / e[0],
  ...
  fit(t, e) {
    ...
    if ((et(Array.isArray(t) || typeof t.getSimplifiedGeometry == 'function', 24), Array.isArray(t))) {
      ...
      const s = Xi(t.getExtent(), this.getProjection())
  ...
  resolveConstraints(t, e, i) {
    ...
    ;((i = i || (t === 0 ? this.cancelAnchor_ : void 0)),
      ...
      (this.getResolution() !== a ||
        ...
        (this.getAnimating() && this.cancelAnimations(),
        this.animateInternal({ rotation: r, center: l, resolution: a, duration: t, easing: Km, anchor: i })))
  }
  beginInteraction() {
...
function g0(n) {
  let t,
    e,
    i,
    o = n.minZoom !== void 0 ? n.minZoom : zr,
    a = n.maxZoom !== void 0 ? n.maxZoom : 28
  const l = n.zoomFactor !== void 0 ? n.zoomFactor : 2,
    h = n.multiWorld !== void 0 ? n.multiWorld : !1,
    c = n.smoothResolutionConstraint !== void 0 ? n.smoothResolutionConstraint : !0,
  ...
  if ((!h && !_ && d.isGlobal() && ((g = !1), (_ = f)), n.resolutions !== void 0)) {
    ...
    ;((e = m[o]),
      (i = m[a] !== void 0 ? m[a] : m[m.length - 1]),
      n.constrainResolution ? (t = u0(m, c, !g && _, u)) : (t = Vl(e, i, c, !g && _, u)))
  } else {
    const y = (f ? Math.max(zt(f), bn(f)) : (360 * Ac.degrees) / d.getMetersPerUnit()) / h0 / Math.pow(2, zr),
      p = y / Math.pow(2, 28 - zr)
    ;((e = n.maxResolution),
      e !== void 0 ? (o = 0) : (e = y / Math.pow(l, o)),
      (i = n.minResolution),
      i === void 0 &&
      ...
      (a = o + Math.floor(Math.log(e / i) / Math.log(l))),
      (i = e / Math.pow(l, a - o)),
      n.constrainResolution ? (t = d0(l, e, i, c, !g && _, u)) : (t = Vl(e, i, c, !g && _, u)))
  }
  return { constraint: t, maxResolution: e, minResolution: i, minZoom: o, zoomFactor: l }
}
function _0(n) {
  if (n.enableRotation !== void 0 ? n.enableRotation : !0) {
    const e = n.constrainRotation
    return e === void 0 || e === !0 ? r0() : e === !1 ? Yl : typeof e == 'number' ? s0(e) : Yl
  }
  return n0
}
function m0(n) {
...
let uu = class {
    ...
    for (; e; ) {
      for (let o = 0; o < e.children.length; o++) {
        const a = e.children[o],
          l = e.leaf ? s(a) : a
        Ts(t, l) && (e.leaf ? i.push(a) : Br(t, l) ? this._all(a, i) : r.push(a))
      }
      e = r.pop()
    }
    return i
  ...
  _chooseSplitAxis(t, e, i) {
    const s = t.leaf ? this.compareMinX : R0,
  ...
  _allDistMargin(t, e, i, s) {
    ...
    for (let h = e; h < i - e; h++) {
      ...
      ;(Cn(o, t.leaf ? r(c) : c), (l += ws(o)))
    }
    for (let h = i - e - 1; h >= e; h--) {
      const c = t.children[h]
      ;(Cn(a, t.leaf ? r(c) : c), (l += ws(a)))
    }
    return l
  }
...
function Zl(n, t, e, i, s) {
  ...
  for (; r.length; ) {
    ...
    ;(E0(n, o, t, e, s), r.push(t, o, o, e))
  }
}
function Kl(n) {
  return new Kt({ fill: Gn(n, ''), stroke: jn(n, ''), text: v0(n), image: I0(n) })
}
function Gn(n, t) {
...
function v0(n) {
  ...
  return t
    ? new Ta({
        ...
        stroke: jn(n, 'text-'),
        backgroundStroke: jn(n, 'text-background-'),
      })
    : void 0
}
function I0(n) {
...
class M0 extends y0 {
  ...
  setStyle(t) {
    ...
    ;((this.style_ = e), (this.styleFunction_ = t === null ? void 0 : Fm(this.style_)), this.changed())
  }
}
const M = {
    BEGIN_GEOMETRY: 0,
...
class Jn extends du {
  ...
  appendFlatPointCoordinates(t, e) {
    ...
    for (let a = 0, l = t.length; a < l; a += e)
      ((s[0] = t[a]), (s[1] = t[a + 1]), Ug(i, s) && ((r[o++] = s[0]), (r[o++] = s[1])))
    return o
  }
  ...
  drawCustom(t, e, i, s) {
    ...
    switch (r) {
      case 'MultiPolygon':
        ...
        ;(this.instructions.push([M.CUSTOM, a, u, t, i, To]),
          this.hitDetectionInstructions.push([M.CUSTOM, a, u, t, s || i, To]))
        break
      case 'Polygon':
      case 'MultiLineString':
        ;((c = []),
          ...
          this.instructions.push([M.CUSTOM, a, c, t, i, Ln]),
          this.hitDetectionInstructions.push([M.CUSTOM, a, c, t, s || i, Ln]))
        break
      case 'LineString':
      case 'Circle':
  ...
  reverseHitDetectionInstructions() {
    ...
    for (e = 0; e < i; ++e)
      ((s = t[e]),
        ...
        r == M.END_GEOMETRY
          ? (o = e)
          : r == M.BEGIN_GEOMETRY && ((s[2] = e), zg(this.hitDetectionInstructions, o, e), (o = -1)))
  }
  setFillStrokeStyle(t, e) {
    const i = this.state
    if (t) {
  ...
  getBufferedMaxExtent() {
    if (!this.bufferedMaxExtent_ && ((this.bufferedMaxExtent_ = Vg(this.maxExtent)), this.maxLineWidth > 0)) {
...
class b0 extends Jn {
  ...
  drawLineString(t, e) {
    ...
    ;(this.updateStrokeStyle(i, this.applyStroke),
      this.beginGeometry(t, e),
      this.hitDetectionInstructions.push(
        [M.SET_STROKE_STYLE, i.strokeStyle, i.lineWidth, i.lineCap, i.lineJoin, i.miterLimit, xe, Ce],
        ri,
      ))
...
class Hl extends Jn {
  ...
  drawCircle(t, e) {
    ...
    ;(this.setFillStrokeStyles_(),
      this.beginGeometry(t, e),
      i.fillStyle !== void 0 && this.hitDetectionInstructions.push([M.SET_FILL_STYLE, Tt]),
      i.strokeStyle !== void 0 &&
        this.hitDetectionInstructions.push([
          M.SET_STROKE_STYLE,
          i.strokeStyle,
  ...
  drawText(t, e) {
    ...
    if (
      ...
      for (let _ = 0, m = u.length; _ < m; ++_) {
        let y
        d ? (y = L0(d * this.resolution, h, g, u[_], c)) : (y = [h.slice(g, u[_])])
        for (let p = 0, E = y.length; p < E; ++p) {
          const x = y[p]
          let C = 0,
            w = x.length
          if (f == null) {
            const S = A0(r.maxAngle, x, 0, x.length, 2)
            ;((C = S[0]), (w = S[1]))
          }
          for (let S = C; S < w; S += c) o.push(x[S], x[S + 1])
          const v = o.length
      ...
      switch (l) {
        ...
        case 'MultiPolygon':
          ...
          h = []
          for (let p = 0, E = y.length; p < E; p += 3)
      ...
      if (u && (d - a) / 2 !== h.length / c) {
        let y = a / 2
        u = u.filter((p, E) => {
          const x = o[(y + E) * 2] === h[E * c] && o[(y + E) * 2 + 1] === h[E * c + 1]
          return (x || --y, x)
        })
      }
      ...
      if (f != si && (r.scale[0] < 0 || r.scale[1] < 0)) {
        let y = r.padding[0],
          ...
          E = r.padding[2],
          x = r.padding[3]
        ;(r.scale[0] < 0 && ((p = -p), (x = -x)), r.scale[1] < 0 && ((y = -y), (E = -E)), (f = [y, p, E, x]))
      }
...
const O0 = { Circle: Hl, Default: Jn, Image: P0, LineString: b0, Polygon: Hl, Text: F0 }
class Jl {
  constructor(t, e, i, s) {
    ;((this.tolerance_ = t),
      (this.maxExtent_ = e),
...
let Di = null
function N0() {
  Di = Ht(1, 1, void 0, { willReadFrequently: !0 })
}
class G0 extends D0 {
  constructor(t) {
    ;(super(t),
  ...
  dispatchRenderEvent_(t, e, i) {
    const s = this.getLayer()
    if (s.hasListener(t)) {
      const r = new k0(t, this.inversePixelTransform, i, e)
      s.dispatchEvent(r)
    }
  }
  preRender(t, e) {
  ...
  getRenderTransform(t, e, i, s, r, o, a) {
    const l = r / 2,
      ...
      d = -t[0] + a,
      f = -t[1]
    return qn(this.tempTransform, l, h, c, u, -i, d, f)
  }
  disposeInternal() {
    ;(delete this.frameState, super.disposeInternal())
  }
}
function j0(n, t, e, i, s, r, o, a, l, h, c, u) {
  let d = n[t],
    f = n[t + 1],
    g = 0,
    _ = 0,
  ...
  if (u) {
    const A = [x, C, P, F]
    ;(ma(A, 0, 4, 2, u, A, A), (j = A[0] > A[2]))
  } else j = x > P
  const N = Math.PI,
    D = [],
    nt = w + i === t
  ;((t = w), (m = 0), (y = v), (d = n[t]), (f = n[t + 1]))
  let I
  if (nt) {
    ;(p(), (I = Math.atan2(f - _, d - g)), j && (I += I > 0 ? -N : N))
    const A = (P + x) / 2,
      T = (F + C) / 2
  ...
  for (let A = 0, T = s.length; A < T; ) {
    ...
    for (; A < T; ++A) {
      const W = j ? T - A - 1 : A,
        q = a * l(h, s[W], c)
      if (t + i < e && y + m < r + Y + q / 2) break
      Y += q
    }
    if (A === Z) continue
    const st = j ? s.substring(T - Z, T - A) : s.substring(Z, A)
    E = m === 0 ? 0 : (r + Y / 2 - y) / m
    const R = Lt(g, d, E),
      It = Lt(_, f, E)
...
`,
            ...
            .reduce(X0, []),
      { width: _, height: m, widths: y, heights: p, lineWidths: E } = bm(l, g),
      x = _ + f,
      C = [],
      w = (x + 2) * c[0],
      v = (m + f) * c[1],
...
`
        ...
        ;((nt += D), (D = 0), (F = d * x + P * f), ++A)
        continue
      }
      const st = g[O + 1] || l.font
      ;(st !== T && (s && j.push('font', st), i && N.push('font', st), (T = st)), (D = Math.max(D, p[I])))
      const R = [Y, F + P * y[I] + d * (y[I] - E[A]), 0.5 * (f + D) + nt]
      ;((F += y[I]), s && j.push('strokeText', R), i && N.push('fillText', R), ++I)
    }
  ...
  calculateImageOrLabelDimensions_(t, e, i, s, r, o, a, l, h, c, u, d, f, g, _, m) {
    ...
    return (
      u !== 0
        ...
        : hi(Math.min(v, v + C), Math.min(S, S + w), Math.max(v, v + C), Math.max(S, S + w), Mi),
    ...
    for (; c < u; ) {
      ...
      switch (R[0]) {
        case M.BEGIN_GEOMETRY:
          ;((O = R[1]),
            (st = R[3]),
            O.getGeometry() ? (a !== void 0 && !Xt(a, st.getExtent()) ? (c = R[2] + 1) : ++c) : (c = R[2]))
          break
        case M.BEGIN_PATH:
          ;(P > T && (this.fill_(t), (P = 0)),
            F > T && (t.stroke(), (F = 0)),
            !P && !F && (t.beginPath(), (m = NaN), (y = NaN)),
            ++c)
          break
        case M.CIRCLE:
          d = R[1]
          ...
          ;(t.moveTo(W + mi, q), t.arc(W, q, mi, 0, 2 * Math.PI, !0), ++c)
          break
        case M.CLOSE_PATH:
          ;(t.closePath(), ++c)
          break
        case M.CUSTOM:
          ...
          const Se = D[c]
          ;(es ? es(h, d, f, 2, Se) : ((Se[0] = h[d]), (Se[1] = h[d + 1]), (Se.length = 2)), yi(Se, A), ++c)
          break
        case M.DRAW_IMAGE:
          ;((d = R[1]), (f = R[2]), (x = R[3]), (g = R[4]), (_ = R[5]))
          let cn = R[6]
          const ve = R[7],
            is = R[8],
            ns = R[9],
          ...
          const Ft = R[14],
            Bt = R[15]
          if (!x && R.length >= 20) {
            ;((C = R[19]), (w = R[20]), (v = R[21]), (S = R[22]))
            const Mt = this.drawLabelWithPointPlacement_(C, w, v, S)
            ;((x = Mt.label), (R[3] = x))
            const Ci = R[23]
          ...
          R.length > 25 && (he = R[25])
          let Ei, $e, Ie
          ;(R.length > 17 ? ((Ei = R[16]), ($e = R[17]), (Ie = R[18])) : ((Ei = si), ($e = !1), (Ie = !1)),
            ss && I ? (pi += nt) : !ss && !I && (pi -= nt))
          let xi = 0
          for (; d < f; d += 2) {
            if (he && he[xi++] < xt / this.pixelRatio) continue
            const Mt = this.calculateImageOrLabelDimensions_(
              ...
              Ci = [t, e, x, Mt, ve, $e ? j : null, Ie ? N : null]
            if (l) {
              if (Ft === 'none') continue
              if (Ft === 'obstacle') {
        ...
        case M.DRAW_CHARS:
          ...
          ;((C = R[11]), (w = R[12]))
          const Na = [R[13], R[13]],
            Lr = this.textStates[w],
            un = Lr.font,
            dn = [Lr.scale[0] * Da, Lr.scale[1] * Da]
          let fn
          un in this.widths_ ? (fn = this.widths_[un]) : ((fn = {}), (this.widths_[un] = fn))
          const Ga = Uc(h, rs, gt, 2),
            ja = Math.abs(dn[0]) * zl(un, C, fn)
          if (bu || ja <= Ga) {
            const Mt = this.textStates[w].textAlign,
              Ci = (Ga - ja) * Vr(C, Mt),
              Ot = j0(h, rs, gt, 2, C, Ci, Lu, Math.abs(dn[0]), zl, un, fn, I ? 0 : this.viewRotation_)
            t: if (Ot) {
              const ce = []
              let Pt, os, as, Ct, Dt
              if (v)
                for (Pt = 0, os = Ot.length; Pt < os; ++Pt) {
                  ;((Dt = Ot[Pt]),
                    (as = Dt[4]),
                    (Ct = this.createLabel(as, w, '', v)),
                    (g = Dt[2] + (dn[0] < 0 ? -br : br)),
                    (_ = Pr * Ct.height + ((0.5 - Pr) * 2 * br * dn[1]) / dn[0] - ka))
        ...
        case M.MOVE_TO_LINE_TO:
          for (
            ...
            ((Z = h[d]),
              ...
              (p = (Z + 0.5) | 0),
              (E = (Y + 0.5) | 0),
              (d == f - 2 || p !== m || E !== y) && (t.lineTo(Z, Y), (m = p), (y = E)))
          ++c
          break
        case M.SET_FILL_STYLE:
          ;((j = R),
            (this.alignFill_ = R[2]),
            P && (this.fill_(t), (P = 0), F && (t.stroke(), (F = 0))),
            (t.fillStyle = R[1]),
            ++c)
          break
        case M.SET_STROKE_STYLE:
          ;((N = R), F && (t.stroke(), (F = 0)), this.setStrokeStyle_(t, R), ++c)
          break
        case M.STROKE:
          ;(T ? F++ : t.stroke(), ++c)
          break
...
class ih {
  ...
  createExecutors_(t) {
    for (const e in t) {
      ...
      for (const r in s) {
        const o = s[r]
        i[r] = new z0(this.resolution_, this.pixelRatio_, this.overlaps_, o)
      }
    }
  }
  hasExecutors(t) {
  ...
  forEachFeatureAtCoordinate(t, e, i, s, r, o) {
    s = Math.round(s)
    const a = s * 2 + 1,
      l = qn(this.hitDetectionTransform_, s + 0.5, s + 0.5, 1 / e, -1 / e, -i, -t[0], -t[1]),
    ...
    let u
    this.renderBuffer_ !== void 0 && ((u = ae()), wc(u, t), Kn(u, e * (this.renderBuffer_ + s), u))
    const d = W0(s)
    let f
    function g(C, w) {
    ...
    for (m = _.length - 1; m >= 0; --m) {
      ...
      for (p = this.executorsByZIndex_[C], y = Ur.length - 1; y >= 0; --y)
        if (((f = Ur[y]), (E = p[f]), E !== void 0 && ((x = E.executeHitDetection(c, l, i, g, u)), x)))
          return x
    }
  }
  getClipCoords(t) {
...
class Y0 extends du {
  ...
  drawCircle(t) {
    if (
      ...
      if (this.fillState_ || this.strokeState_) {
        ...
        const e = D_(t, this.transform_, this.pixelCoordinates_),
          i = e[2] - e[0],
          s = e[3] - e[1],
          r = Math.sqrt(i * i + s * s),
          o = this.context_
  ...
  setFillStrokeStyle(t, e) {
    if (!t) this.fillState_ = null
      ...
      const i = t.getColor()
      this.fillState_ = { fillStyle: se(i || Tt) }
    }
...
const ee = 0.5
function B0(n, t, e, i, s, r, o) {
  const a = n[0] * ee,
    l = n[1] * ee,
    h = Ht(a, l)
  h.imageSmoothingEnabled = !1
  const c = h.canvas,
    u = new Y0(h, ee, s, null, o),
    d = e.length,
  ...
  for (let m = 1; m <= d; ++m) {
    ...
    for (let w = 0, v = E.length; w < v; ++w) {
      ...
      if (!P || !Xt(s, P.getExtent())) continue
      const F = S.clone(),
        j = F.getFill()
      j && j.setColor(C)
      const N = F.getStroke()
      ...
      if (A === 'GeometryCollection') {
        const T = P.getGeometriesArrayRecursive()
        for (let O = 0, Z = T.length; O < Z; ++O) {
          const Y = T[O]
          I[Y.getType().replace('Multi', '')].push(Y, F)
        }
      } else I[A.replace('Multi', '')].push(P, F)
    }
  }
  ...
  for (let m = 0, y = _.length; m < y; ++m) {
    ...
    for (const E in p) {
      ...
      for (let C = 0, w = x.length; C < w; C += 2) {
        u.setStyle(x[C + 1])
        for (let v = 0, S = t.length; v < S; ++v) (u.setTransform(t[v]), u.drawGeometry(x[C]))
      }
    }
  }
...
function nh(n, t, e, i, s, r, o) {
  ...
  return (q0(n, t, e, i, r, o), a)
}
function q0(n, t, e, i, s, r) {
...
class sy extends G0 {
  ...
  renderWorlds(t, e, i) {
    const s = e.extent,
      ...
      E = p ? zt(c) : null,
      x = p ? Math.ceil((s[2] - c[2]) / E) + 1 : 1
    let C = p ? Math.floor((s[0] - c[0]) / E) : 0
    do {
      const w = this.getRenderTransform(o, a, h, d, m, y, C * E)
      t.execute(_, 1, w, h, g, void 0, i)
    } while (++C < x)
  }
  ...
  renderFrame(t, e) {
    ...
    ;(M_(this.pixelTransform, 1 / i, 1 / i), P_(this.inversePixelTransform, this.pixelTransform))
    const r = L_(this.pixelTransform)
  ...
  getFeatures(t) {
    return new Promise(e => {
      if (!this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
        ...
        this.hitDetectionImageData_ = B0(i, c, this.renderedFeatures_, h.getStyleFunction(), l, r, o)
      }
      e(V0(t, this.renderedFeatures_, this.hitDetectionImageData_))
    })
  }
  forEachFeatureAtCoordinate(t, e, i, s, r) {
  ...
  prepareFrame(t) {
    ...
    const m = h.center.slice(),
      ...
      E = [y.slice()],
      x = c.getExtent()
    if (i.getWrapX() && c.canWrapX() && !Gi(x, t.extent)) {
      const I = zt(x),
        A = Math.max(zt(y) / 2, I)
      ;((y[0] = x[0] - A), (y[2] = x[2] + A), f_(m, c))
      const T = Lc(E[0], c)
      T[0] < x[0] && T[2] < x[2]
        ? E.push([T[0] + I, T[1], T[2] + I, T[3]])
        : T[0] > x[0] && T[2] > x[2] && E.push([T[0] - I, T[1], T[2] - I, T[3]])
    }
    if (
      this.ready &&
    ...
    this.replayGroup_ = null
    const C = new Jl(Lo(u, d), y, u, d)
    let w
    this.getLayer().getDeclutter() && (w = new Jl(Lo(u, d), y, u, d))
    let v
    for (let I = 0, A = E.length; I < A; ++I) i.loadFeatures(E[I], u, c)
    const S = K0(u, d)
    let P = !0
    const F = I => {
        let A
        ...
        if ((T && (A = T(I, u)), A)) {
          const O = this.renderFeature(I, S, A, C, v, w)
          P = P && !O
        }
      },
      j = xr(y),
      N = i.getFeaturesInExtent(j)
    _ && N.sort(_)
    ...
    return (
      w && (this.declutterExecutorGroup = new ih(y, u, d, i.getOverlaps(), w.finish(), e.getRenderBuffer())),
      (this.renderedResolution_ = u),
      (this.renderedRevision_ = f),
      (this.renderedRenderOrder_ = _),
...
class Pa extends ry {
  constructor(t) {
    ;((t = t || {}),
      ...
      (this.strategy_ = t.strategy !== void 0 ? t.strategy : oy))
  ...
  addFeaturesInternal(t) {
    ...
    if ((this.featuresRtree_ && this.featuresRtree_.load(e, s), this.hasListener(_t.ADDFEATURE)))
      for (let r = 0, o = i.length; r < o; r++) this.dispatchEvent(new Ae(_t.ADDFEATURE, i[r]))
  }
  ...
  clear(t) {
    if (t) {
      for (const i in this.featureChangeKeys_) this.featureChangeKeys_[i].forEach(At)
  ...
  removeFeatureInternal(t) {
    ...
    if (!i) return
    ;(i.forEach(At), delete this.featureChangeKeys_[e])
    const s = t.getId()
    return (
...
function _u(n, t, e) {
  if (t instanceof $t) {
    bs(n, t.getCoordinates(), !1, e)
    return
  }
  if (t instanceof ci) {
    const i = t.getCoordinates()
    for (let s = 0, r = i.length; s < r; ++s) bs(n, i[s], !1, e)
    return
  }
  if (t instanceof Yt) {
    const i = t.getCoordinates()
    for (let s = 0, r = i.length; s < r; ++s) bs(n, i[s], !0, e)
    return
  }
  if (t instanceof ui) {
    const i = t.getCoordinates()
    for (let s = 0, r = i.length; s < r; ++s) {
      const o = i[s]
      for (let a = 0, l = o.length; a < l; ++a) bs(n, o[a], !0, e)
    }
    return
  }
  if (t instanceof Be) {
...
class uy extends vr {
  constructor(t) {
    ...
    ;((this.geometryFunction_ = i),
      ...
      t.freehand
        ...
        : (this.freehandCondition_ = t.freehandCondition ? t.freehandCondition : e0),
  ...
  setTrace(t) {
    let e
    ;(t ? (t === !0 ? (e = or) : (e = t)) : (e = Jm), (this.traceCondition_ = e))
  }
  setMap(t) {
        ...
        : this.condition_(t)
          ? ((this.lastDragTime_ = Date.now()),
            (this.downTimeout_ = setTimeout(() => {
              this.handlePointerMove_(new a0(ct.POINTERMOVE, t.map, t.originalEvent, !1, t.frameState))
  ...
  addTracedCoordinates_(t, e, i) {
    ...
    if (e < i) {
      ...
      let o = Math.floor(i)
      o === i && (o -= 1)
      for (let a = r; a <= o; ++a) s.push(zi(t.coordinates, a))
    } else {
  ...
  updateTrace_(t) {
    ...
    const i = cy(t.coordinate, e, this.getMap(), this.snapTolerance_)
...
class gy extends vr {
  constructor(t) {
    ;(super(t),
      ...
      (this.condition_ = t.condition ? t.condition : i0),
  ...
  writeCircleGeometry_(t, e) {
    const i = e.getCenter(),
      ...
      r = { feature: t, geometry: e, index: wn, segment: [i, i] },
      o = [s, r]
    ...
    if (i) {
      ...
      for (let h = 0, c = a.length; h < c; ++h) {
        ...
        if (
          (g && (f += '-' + g.join('-')),
          l[f] || (l[f] = new Array(2)),
          u.geometry.getType() === 'Circle' && u.index === wn)
        ) {
          const _ = hh(e, u)
  ...
  handleUpEvent(t) {
    for (let e = this.dragSegments_.length - 1; e >= 0; --e) {
      ...
      } else this.rBush_.update(bt(i.segment), i)
    }
    return (
    ...
    if (o && o.length > 0) {
      ...
      if (a || d <= this.pixelTolerance_) {
        ...
        if (
          ...
          l.geometry.getType() === 'Circle' && l.index === wn)
        )
          ...
          for (let E = 1, x = o.length; E < x; ++E) {
            ...
            if ((Zt(h[0], C[0]) && Zt(h[1], C[1])) || (Zt(h[0], C[1]) && Zt(h[1], C[0]))) {
              const w = K(o[E].geometry)
              w in p || ((p[w] = !0), (f[K(C)] = !0))
            } else break
          }
        }
    ...
    for (g in e) {
      ...
      if (i) {
        ...
        if (
          ...
          this.rBush_.insert(bt(m.segment), m)
        }
...
function lh(n, t, e) {
  ...
  const s = J(n)
  return ((qi[0] = J(t.segment[0])), (qi[1] = J(t.segment[1])), d_(s, qi))
}
function hh(n, t, e) {
  const i = t.geometry
  if (i.getType() === 'Circle' && t.index === wn) return nn(i.getClosestPoint(J(n)))
  const s = J(n)
  return ((qi[0] = J(t.segment[0])), (qi[1] = J(t.segment[1])), nn(da(s, qi)))
}
function my() {
  const n = nu()
  return function (t, e) {
...
class Ey extends vr {
  ...
  addFeature(t, e) {
    ...
    if (s) {
      ...
      if (r) {
        ...
        const o = []
        if ((r(o, s), o.length === 1)) this.rBush_.insert(bt(o[0]), { feature: t, segment: o[0] })
        else if (o.length > 1) {
          const a = o.map(h => bt(h)),
  ...
  handleEvent(t) {
    ...
    return (
      e &&
        ...
        this.dispatchEvent(
          new py(yy.SNAP, { vertex: t.coordinate, vertexPixel: t.pixel, feature: e.feature }),
        )),
      super.handleEvent(t)
    )
  }
  ...
  snapTo(t, e, i) {
    ...
    const s = J(e),
      r = xr(Kn(bt([s]), i.getView().getResolution() * this.pixelTolerance_)),
...
class xy extends vr {
  ...
  handleDownEvent(t) {
    ...
    if (
      ...
      return (this.dispatchEvent(new js(Qr.TRANSLATESTART, e, t.coordinate, this.startCoordinate_, t)), !0)
    }
    return !1
  }
  handleUpEvent(t) {
    if (this.lastCoordinate_) {
      ...
      const e = this.features_ || new oi([this.lastFeature_])
      return (
        this.dispatchEvent(new js(Qr.TRANSLATEEND, e, t.coordinate, this.startCoordinate_, t)),
        (this.startCoordinate_ = null),
        !0
      )
    }
  ...
  handleDragEvent(t) {
    if (this.lastCoordinate_) {
      ...
      ;(a.forEach(function (l) {
        ...
        this.dispatchEvent(new js(Qr.TRANSLATING, a, e, this.startCoordinate_, t)))
    }
  }
  handleMoveEvent(t) {
...
const Ry = Object.assign,
  ...
  Ao = (n, t) => wy.call(n, t),
  Hi = Array.isArray,
  Xs = n => pu(n) === '[object Map]',
  Ty = n => typeof n == 'string',
  Qn = n => typeof n == 'symbol',
  Ir = n => n !== null && typeof n == 'object',
  Sy = Object.prototype.toString,
  pu = n => Sy.call(n),
  vy = n => pu(n).slice(8, -1),
  ba = n => Ty(n) && n !== 'NaN' && n[0] !== '-' && '' + parseInt(n, 10) === n,
  Tn = (n, t) => !Object.is(n, t)
/**
...
function ke(n, t, e, i, s, r) {
  ...
  if ((La(), t === 'clear')) o.forEach(a)
    ...
    if (l && e === 'length') {
      const c = Number(i)
      o.forEach((u, d) => {
        ;(d === 'length' || d === Xn || (!Qn(d) && d >= c)) && a(u)
      })
    } else
      switch (((e !== void 0 || o.has(void 0)) && a(o.get(e)), h && a(o.get(Xn)), t)) {
        case 'add':
          l ? h && a(o.get('length')) : (a(o.get(li)), Xs(n) && a(o.get(Oo)))
          break
        case 'delete':
          l || (a(o.get(li)), Xs(n) && a(o.get(Oo)))
          break
        case 'set':
          Xs(n) && a(o.get(li))
          break
...
function Pi(n) {
  const t = H(n)
  return t === n ? t : (St(t, 'iterate', Xn), Ue(n) ? t : t.map(mt))
}
function Fa(n) {
  return (St((n = H(n)), 'iterate', Xn), n)
}
const by = {
  __proto__: null,
  [Symbol.iterator]() {
  ...
  concat(...n) {
    return Pi(this).concat(...n.map(t => (Hi(t) ? Pi(t) : t)))
  },
  entries() {
...
function io(n, t, e) {
  ...
  St(i, 'iterate', Xn)
  const s = i[t](...e)
  return (s === -1 || s === !1) && Uy(e[0]) ? ((e[0] = H(e[0])), i[t](...e)) : s
}
function pn(n, t, e = []) {
  ;(My(), La())
  const i = H(n)[t].apply(n, e)
  return (Aa(), Py(), i)
}
const Ay = Cy('__proto__,__v_isRef,__isVue'),
  Ru = new Set(
...
class wu {
  ...
  get(t, e, i) {
    ...
    if (e === '__v_raw')
      return i === (s ? (r ? Yy : vu) : r ? Wy : Su).get(t) ||
    ...
    if (!s) {
      let l
      if (o && (l = by[e])) return l
      if (e === 'hasOwnProperty') return Fy
    }
    const a = Reflect.get(t, e, Ji(t) ? t : i)
    return (Qn(e) ? Ru.has(e) : Ay(e)) || (s || St(t, 'get', e), r)
      ? a
      : Ji(a)
        ? o && ba(e)
          ? a
...
class Oy extends wu {
  ...
  set(t, e, i, s) {
    ...
    if (!this._isShallow) {
      const l = rn(r)
      if ((!Ue(i) && !rn(i) && ((r = H(r)), (i = H(i))), !Hi(t) && Ji(r) && !Ji(i)))
        return (l || (r.value = i), !0)
    }
    const o = Hi(t) && ba(e) ? Number(e) < t.length : Ao(t, e),
      a = Reflect.set(t, e, i, Ji(t) ? t : s)
    return (t === H(s) && (o ? Tn(i, r) && ke(t, 'set', e, i) : ke(t, 'add', e, i)), a)
  }
  deleteProperty(t, e) {
    const i = Ao(t, e)
    t[e]
  ...
  ownKeys(t) {
    return (St(t, 'iterate', Hi(t) ? 'length' : li), Reflect.ownKeys(t))
  }
}
class Dy extends wu {
  constructor(t = !1) {
  ...
  const e = {
    get(s) {
      const r = this.__v_raw,
        o = H(r),
        a = H(s)
      n || (Tn(s, a) && St(o, 'get', s), St(o, 'get', a))
      const { has: l } = Ls(o),
        h = t ? Do : n ? ko : mt
    ...
    get size() {
      const s = this.__v_raw
      return (!n && St(H(s), 'iterate', li), s.size)
    },
    has(s) {
      const r = this.__v_raw,
        o = H(r),
        a = H(s)
      return (n || (Tn(s, a) && St(o, 'has', s), St(o, 'has', a)), s === a ? r.has(s) : r.has(s) || r.has(a))
    },
    forEach(s, r) {
      const o = this,
        a = o.__v_raw,
      ...
      n
        ...
        : {
            ...
            set(s, r) {
              ...
              const c = l.call(o, s)
              return (o.set(s, r), h ? Tn(r, c) && ke(o, 'set', s, r) : ke(o, 'add', s, r), this)
            },
            delete(s) {
              const r = H(this),
                { has: o, get: a } = Ls(r)
  ...
  return (i, s, r) =>
    s === '__v_isReactive'
      ...
      : s === '__v_isReadonly'
        ...
        : s === '__v_raw'
          ? i
          : Reflect.get(Ao(e, s) && s in i ? e : i, s, r)
}
const Xy = { get: Tu(!1, !1) },
  zy = { get: Tu(!0, !1) },
  Su = new WeakMap(),
...
function Vy(n) {
  return n.__v_skip || !Object.isExtensible(n) ? 0 : By(vy(n))
}
function Iu(n) {
  return rn(n) ? n : Pu(n, !1, ky, Xy, Su)
}
function Mu(n) {
  return Pu(n, !0, Ny, zy, vu)
}
...
class Ky {
  ...
  set value(t) {
    ...
    ;((t = i ? t : H(t)),
      Tn(t, e) && ((this._rawValue = t), (this._value = i ? t : mt(t)), this.dep.trigger()))
  }
}
var Qt = (n => (
  (n.SELECT = 'select'),
...
const i1 = ['Point', 'LineString', 'Polygon', 'Circle'],
  n1 = getComputedStyle(document.documentElement).getPropertyValue('--ol-foreground-color'),
  s1 = new Kt({
    fill: new Ve({ color: 'rgba(255,255,255,0.5)' }),
    stroke: new Ee({ width: 2.5, color: 'red' }),
    image: new hn({ radius: 5, stroke: new Ee({ width: 2.5, color: 'red' }) }),
  }),
  r1 = { duration: 500, maxZoom: 14, padding: 100 },
...
class a1 extends we {
  ...
  constructor(t, e = {}) {
    ...
    const i = uh(this.#b.bind(this), 50)
    t.on('pointermove', i)
  }
  get source() {
    return this.#t
  ...
  addFeatureFromWKT(t, e, i = 'EPSG:4326') {
    if (!t || !Jy(t) || (e && this.#t.getFeatureById(e))) return !1
    let s
    ...
    const r = Qy(t)
    return (s.setId(e ?? En(r ?? '')), this.#t.addFeature(s), !0)
  }
      ...
      if (o.geometryType === 'circle' && r === 'Polygon') {
        ...
        if (Array.isArray(h) && c != null) {
          const u = gn(h),
            ...
            f = new pt(new Hn(d ? u : h, c))
          ;(f.setId(a ?? En('circle')), this.#t.addFeature(f))
        }
  ...
  enableDraw(t, e) {
    if (this.#n) {
      ...
      ;(this.disableSelect(),
        ...
        (this.#x = this.#c.value.on('drawend', i => {
          this.dispatchEvent(i)
          const s = i.feature,
            o = s.getGeometry().getFlatCoordinates(),
            [a, l] = o,
  ...
  select(t, e) {
    ...
    if (
      ...
      const c = r1
      ;(e?.fit !== !1 && (Object.assign(c, e?.fit === !0 ? {} : e?.fit), (c.padding = e1(c.padding))),
        this.#m.fit(a, c))
    }
    return l
  }
  ...
  enableTranslate(t) {
    return (
      ...
      this.#l.value
        ...
        : ((this.#l.value = new xy({ features: this.#e })),
  ...
  enableSnap() {
    ...
    ;((this.#f = new Ey({ source: this.#t, intersection: !0 })), this.#n?.addInteraction(this.#f))
  }
  removeFeatures(t) {
    if (t == null) {
  ...
  #A() {
    const t = i => {
      const s = i.element,
        ...
        [o] = this.#i([s]),
        a = this.#i(r)
      this.dispatchEvent(new $y(Qt.SELECT, a, o, r, []))
    }
    this.#e.on('add', t)
    const e = i => {
      const s = i.element,
        ...
        a = this.#i([s]),
        l = [s]
      this.dispatchEvent(new qy(Qt.DESELECT, a, r, o, l))
    }
    this.#e.on('remove', e)
  }
  #F() {
  ...
  #i(t) {
    ...
    return (
      ...
      e.map(i => {
        if (i.getGeometry()?.getType() === 'Circle') return this.#T(i)
...
const l1 = 'LINESTRING(106.55773424492708 26.68974989181626,106.79592190619702 26.712142565234185)',
  h1 =
...
document.title = kg.title
document.querySelector('#app').innerHTML = Ng
const f1 = [106.675271, 26.579508],
  g1 = Cd(f1),
  _1 = new og({
    target: 'ol-geom-editor-map',
    layers: [new bg({ source: new Dg() })],
    view: new te({ center: g1, zoom: 10 }),
  }),
  m1 = {
...
document.querySelector('#add-wkt').addEventListener('click', y1)
document.querySelector('#add-JSON').addEventListener('click', p1)
document.querySelector('#add-JSONObj').addEventListener('click', E1)
document.querySelector('#remove-feature').addEventListener('click', C1)
document.querySelector('#remove-selected-features').addEventListener('click', x1)
document.querySelector('#remove-all-features').addEventListener('click', R1)
document.querySelector('#select-features').addEventListener('click', w1)
document.querySelector('#deselect-features').addEventListener('click', T1)
document.querySelector('#enable-select').addEventListener('click', S1)
document.querySelector('#enable-select-single').addEventListener('click', v1)
document.querySelector('#disable-select').addEventListener('click', I1)
document.querySelector('#translate-features').addEventListener('click', M1)
document.querySelector('#disable-translate').addEventListener('click', P1)
document.querySelector('#enable-modify').addEventListener('click', b1)
document.querySelector('#disable-modify').addEventListener('click', L1)
document.querySelector('#select-type').addEventListener('change', O1)
document.querySelector('#freehand').addEventListener('change', D1)
function y1() {
  ;(console.log('addWKT'), k.addFeatureFromWKT(l1, 'line1'), k.addFeatureFromWKT(h1))
}
function p1() {
  ;(console.log('addJSON'), k.addFeatureFromJSON(u1))
}
function E1() {
  ;(console.log('addJSONObj'), k.addFeatureFromJSON(c1), k.addFeatureFromJSON(d1))
}
function x1() {
  k.removeFeatures()
}
