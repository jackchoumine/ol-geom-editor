...
class X0 extends xe {
  ...
  constructor(t, e = {}) {
    ...
    const n = Dl(this.#L.bind(this), 50)
    t.on('pointermove', n)
  }
  get source() {
    return this.#t
    ...
    ;(t !== null && (this.modifyingStyle = t),
      ...
      this.#a.on('modifystart', e => {
        ...
        const n = this.#n(e.features),
          i = new Ol(qt.MODIFY_BEGIN, n, e.features)
        this.dispatchEvent(i)
      }),
      this.#a.on('modifyend', e => {
        this.dispatchEvent(e)
        const n = this.#n(e.features),
          i = new Ol(qt.MODIFY_COMPLETE, n, e.features)
        this.dispatchEvent(i)
      }),
      this.enableSnap())
  }
  ...
  #S(t, e, n) {
    ...
    if (n) {
      ...
      return new Al(qt.TRANSLATE_END, i, t, a, c)
    }
    return new Al(qt.TRANSLATE_START, i, t, a)
  }
  #G(t) {
