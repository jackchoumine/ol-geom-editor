...
function rg(s) {
  const t = 'matrix(' + s.join(', ') + ')'
  if (Do) return t
  const e = Ua || (Ua = document.createElement('div'))
  return ((e.style.transform = t), e.style.transform)
}
...
function hg(s, t, e, n, i) {
  const [r, o, a, l, h, c, u, d] = cg(s, t, e, n)
...
function Ag(s) {
  ;(Cg(s.getCode(), s), Ps(s, s, jo))
}
function Og(s) {
  s.forEach(Ag)
}
function Rt(s) {
  return typeof s == 'string' ? Eg(s) : s || null
}
function Ha(s) {
  ;(Og(s),
    s.forEach(function (t) {
...
function kg(s, t) {
  if (s === t) return !0
  const e = s.getUnits() === t.getUnits()
  return (s.getCode() === t.getCode() || sc(s, t) === jo) && e
}
function sc(s, t) {
  const e = s.getCode(),
    n = t.getCode()
...
function H(s, t) {
  return (
    Hr &&
      ...
      s[1] <= 90 &&
      ((Hr = !1),
      Pg('Call useGeographic() from ol/proj once to work with [longitude, latitude] coordinates.')),
    s
  )
}
function er(s, t) {
...
class rc extends xe {
  ...
  getExtent(t) {
    if (this.extentRevision_ != this.getRevision()) {
      const e = this.computeExtent(this.extent_)
      ;((isNaN(e[0]) || isNaN(e[1])) && No(e), (this.extentRevision_ = this.getRevision()))
    }
        ...
        n.getUnits() == 'tile-pixels'
          ? function (r, o, a) {
              const l = n.getExtent(),
                h = n.getWorldExtent(),
                c = pi(h) / pi(l)
              return (Oi(Ja, h[0], h[3], c, -c, 0, 0, 0), en(r, 0, r.length, a, Ja, o), Jr(n, e)(r, o, a))
            }
          : Jr(n, e)
    return (this.applyTransform(i), this)
  }
...
class We extends rc {
  ...
  setFlatCoordinates(t, e) {
    ;((this.stride = Os(t)), (this.layout = t), (this.flatCoordinates = e))
  }
  setCoordinates(t, e) {
    P()
  }
  ...
  translate(t, e) {
    ...
    if (n) {
      const i = this.getStride()
      ;(jg(n, 0, n.length, i, t, e, n), this.changed())
    }
  }
}
function Xg(s) {
...
function Yg(s, t, e, n, i, r, o, a, l, h, c) {
  c = c || [NaN, NaN]
  for (let u = 0, d = e.length; u < d; ++u) {
    const f = e[u]
...
function ac(s, t, e, n, i, r, o, a) {
  for (let l = 0, h = e.length; l < h; ++l) {
    const c = e[l]
    ;((o = Ug(s, t, c, n, i, r, o)), a.push(o), (t = c))
  }
  return o
}
function Zg(s, t, e, n, i, r, o, a) {
  for (let l = 0, h = e.length; l < h; ++l) {
    const c = e[l],
      u = []
    ;((o = ac(s, t, c, n, i, r, o, u)), a.push(u), (t = c[c.length - 1]))
  }
  return o
}
...
class xi extends We {
  ...
  getArea() {
    return lc(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride)
  }
  getCoordinates() {
...
class jt extends We {
  ...
  intersectsExtent(t) {
    return ko(t, this.flatCoordinates[0], this.flatCoordinates[1])
  }
  setCoordinates(t, e) {
    ;(this.setLayout(e, t, 0),
      this.flatCoordinates || (this.flatCoordinates = []),
      (this.flatCoordinates.length = oc(this.flatCoordinates, 0, t, this.stride)),
      this.changed())
  }
}
...
function Hg(s, t, e, n, i) {
  ...
  for (let o = 0, a = e.length; o < a; ++o) {
    const l = e[o]
    ;((r = cc(s, t, l, n, i, 2 * o, r)), (t = l[l.length - 1]))
  }
  return r
}
...
function dc(s, t, e, n, i) {
  ...
  if (e.length === 1) return !0
  for (let r = 1, o = e.length; r < o; ++r)
    if ($g(s, e[r - 1], e[r], n, i) && !ir(s, e[r - 1], e[r], n, i)) return !1
  return !0
}
function t_(s, t, e, n, i) {
  for (let r = 0, o = e.length; r < o; ++r) {
    const a = e[r]
    if (dc(s, t, a, n, i)) return !0
    t = a[a.length - 1]
  }
  return !1
}
...
function n_(s, t, e, n, i) {
  for (let r = 0, o = e.length; r < o; ++r) {
    const a = e[r]
    if (!gc(s, t, a, n, i)) return !1
    a.length && (t = a[a.length - 1])
  }
  return !0
}
function to(s, t, e, n, i) {
  i = i !== void 0 ? i : !1
  for (let r = 0, o = e.length; r < o; ++r) {
    const a = e[r],
      l = fc(s, t, a, n)
    ;((r === 0 ? (i && l) || (!i && !l) : (i && !l) || (!i && l)) && e_(s, t, a, n), (t = a))
  }
  return t
}
function tl(s, t, e, n, i) {
  for (let r = 0, o = e.length; r < o; ++r) t = to(s, t, e[r], n, i)
  return t
}
class Xt extends We {
  constructor(t, e, n) {
  ...
  getArea() {
    return hc(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride)
  }
  getCoordinates(t) {
    let e
    return (
      t !== void 0
        ? ((e = this.getOrientedFlatCoordinates().slice()), to(e, 0, this.ends_, this.stride, t))
        : (e = this.flatCoordinates),
  ...
  getFlatInteriorPoint() {
    if (this.flatInteriorPointRevision_ != this.getRevision()) {
      ...
      ;((this.flatInteriorPoint_ = cc(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, t, 0)),
        (this.flatInteriorPointRevision_ = this.getRevision()))
    }
    return this.flatInteriorPoint_
  }
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      const t = this.flatCoordinates
      ;(gc(t, 0, this.ends_, this.stride)
        ? (this.orientedFlatCoordinates_ = t)
        : ((this.orientedFlatCoordinates_ = t.slice()),
          (this.orientedFlatCoordinates_.length = to(
            this.orientedFlatCoordinates_,
            0,
            this.ends_,
            this.stride,
  ...
  getSimplifiedGeometryInternal(t) {
    const e = [],
      n = []
    return (
      (e.length = ac(this.flatCoordinates, 0, this.ends_, this.stride, Math.sqrt(t), e, 0, n)),
      new Xt(e, 'XY', n)
    )
  }
  getType() {
  ...
  intersectsExtent(t) {
    return dc(this.getOrientedFlatCoordinates(), 0, this.ends_, this.stride, t)
  }
  setCoordinates(t, e) {
    ;(this.setLayout(e, t, 2), this.flatCoordinates || (this.flatCoordinates = []))
...
function i_(s, t, e, n) {
  e = e || 32
  const i = []
  for (let r = 0; r < e; ++r) ne(i, Lg(s, t, (2 * Math.PI * r) / e, n))
...
class je {
  ...
  clone() {
    const t = this.getColor()
    return new je({ color: Array.isArray(t) ? t.slice() : t || void 0 })
  }
  getColor() {
    return this.color_
  }
...
function o_(s, t, e, n, i, r, o) {
  if (o) return eo(s, t, e[e.length - 1], n, i, r)
  let a
  ...
  for (let l = 0, h = e.length; l < h; ++l) {
    ...
    if (t != c) {
      ...
      if (i <= s[c - 1]) return eo(s, t, c, n, i, !1)
      t = c
    }
  }
  return null
...
class Ut extends We {
  ...
  forEachSegment(t) {
    return uc(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t)
  }
  getCoordinateAtM(t, e) {
    return this.layout != 'XYM' && this.layout != 'XYZM'
      ? null
      : ((e = e !== void 0 ? e : !1),
        eo(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, e))
  }
  getCoordinates() {
    return Fe(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride)
  }
  getCoordinateAt(t, e) {
    return _c(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, e, this.stride)
  }
  getLength() {
    return mc(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride)
  }
  getFlatMidpoint() {
    return (
...
class sr {
  ...
  setScale(t) {
    ;((this.scale_ = t), (this.scaleArray_ = Ds(t)))
  }
  listenImageChange(t) {
    P()
  }
...
function ks(s) {
  return Array.isArray(s) ? s : c_(s)
}
function u_(s) {
  let t, e, n, i, r
  if ((l_.exec(s) && (s = h_(s)), a_.exec(s))) {
    const o = s.length - 1
    let a
    o <= 4 ? (a = 1) : (a = 2)
    const l = o === 4 || o === 8
    ...
    s.startsWith('rgba(')
      ? ((r = s.slice(5, -1).split(',').map(Number)), nl(r))
      : s.startsWith('rgb(')
        ? ((r = s.slice(4, -1).split(',').map(Number)), r.push(1), nl(r))
        : tt(!1, 14)
  return r
}
function nl(s) {
...
const io = {},
  g_ = (function () {
    ...
    function a(h, c, u) {
      ...
      for (let f = 0; f < n; ++f) {
        const g = e[f]
        if (((o = js(h + ' ' + c + ' ' + t + g, i)), u != g)) {
          const _ = js(h + ' ' + c + ' ' + t + u + ',' + g, i)
          d = d && _ != o
        }
      }
      return !!d
...
`),
            ...
            ? (Oo(io), (vn = null), (no = void 0), Se.set(f, 100))
...
function Cc(s, t) {
  return (vn || (vn = Kt(1, 1)), s != no && ((vn.font = s), (no = vn.font)), vn.measureText(t))
}
function js(s, t) {
  return Cc(s, t).width
}
...
`,
    ...
    .reduce((i, r) => Math.max(i, js(s, r)), 0)
  return ((e[t] = n), n)
}
function m_(s, t) {
  const e = [],
...
function p_(s, t, e, n, i, r, o, a, l, h, c) {
  ;(s.save(),
    ...
    n.contextInstructions
      ? (s.translate(l, h), s.scale(c[0], c[1]), y_(n, s))
      : c[0] < 0 || c[1] < 0
...
function E_(s, t) {
  if (!Er) {
    const e = new je({ color: 'rgba(255,255,255,0.4)' }),
      n = new _e({ color: '#3399CC', width: 1.25 })
    Er = [new Vt({ image: new Hn({ fill: e, stroke: n, radius: 5 }), fill: e, stroke: n })]
  }
  return Er
}
function wc() {
  const s = {},
    ...
    n = 3
  return (
    (s.Polygon = [new Vt({ fill: new je({ color: [255, 255, 255, 0.5] }) })]),
...
class $o {
  ...
  setScale(t) {
    ;((this.scale_ = t), (this.scaleArray_ = Ds(t !== void 0 ? t : 1)))
  }
  setStroke(t) {
    this.stroke_ = t
  }
    ...
    function (i, r, o, a) {
      if (i !== void 0) {
        const l = s[0],
          h = s[s.length - 1],
          c = e ? qo(l, e, o, n) : l
        if (a) return t ? Ho(i, c, h) : ct(i, h, c)
        const u = Math.min(c, i),
...
function v_(s, t, e, n, i, r) {
  return (
    (n = n !== void 0 ? n : !0),
    (e = e !== void 0 ? e : 0),
    function (o, a, l, h) {
      if (o !== void 0) {
        const c = i ? qo(t, i, l, r) : t
        if (h) return n ? Ho(o, c, e) : ct(o, e, c)
        const u = 1e-9,
          d = Math.ceil(Math.log(t / c) / Math.log(s) - u),
          f = -a * (0.5 - u) + 0.5,
          g = Math.min(c, o),
...
function al(s, t, e, n, i) {
  return (
    ...
    function (r, o, a, l) {
      if (r !== void 0) {
        const h = n ? qo(s, n, a, i) : s
        return !e || !l ? ct(r, t, h) : Ho(r, h, t)
      }
    }
  )
}
...
class hl extends xe {
  constructor(t) {
    ;(super(),
      ...
      (this.animations_ = []),
      this.updateAnimationKey_,
      (this.projection_ = Xo(t.projection, 'EPSG:3857')),
      (this.viewportSize_ = [100, 100]),
      (this.targetCenter_ = null),
      this.targetResolution_,
      this.targetRotation_,
  ...
  cancelAnimations() {
    ...
    for (let e = 0, n = this.animations_.length; e < n; ++e) {
      const i = this.animations_[e]
      if ((i[0].callback && ss(i[0].callback, !1), !t))
        for (let r = 0, o = i.length; r < o; ++r) {
          const a = i[r]
          if (!a.complete) {
            t = a.anchor
  ...
  calculateCenterRotate(t, e) {
    let n
    const i = this.getCenterInternal()
    return (i !== void 0 && ((n = [i[0] - e[0], i[1] - e[1]]), vg(n, t - this.getRotation()), Tg(n, e)), n)
  }
  calculateCenterZoom(t, e) {
    let n
    const i = this.getCenterInternal(),
  ...
  calculateExtentInternal(t) {
    ...
    tt(n !== void 0, 2)
    const i = this.getRotation()
    return (tt(i !== void 0, 3), hg(e, n, i, t))
  }
  getMaxResolution() {
    return this.maxResolution_
  }
  ...
  fitInternal(t, e) {
    ...
    e.duration !== void 0
      ? this.animateInternal({ resolution: l, center: _, duration: e.duration, easing: e.easing }, m)
      : ((this.targetResolution_ = l), (this.targetCenter_ = _), this.applyTargetState_(!1, !0), ss(m, !0))
  }
  centerOn(t, e, n) {
  ...
  resolveConstraints(t, e, n) {
    ...
    ;((n = n || (t === 0 ? this.cancelAnchor_ : void 0)),
      ...
      (this.getResolution() !== a ||
        ...
        (this.getAnimating() && this.cancelAnimations(),
        this.animateInternal({ rotation: r, center: l, resolution: a, duration: t, easing: P_, anchor: n })))
  }
  beginInteraction() {
...
function A_(s) {
  if (s.extent !== void 0) {
    const e = s.smoothExtentConstraint !== void 0 ? s.smoothExtentConstraint : !0
    return ol(s.extent, s.constrainOnlyCenter, e)
  }
  const t = Xo(s.projection, 'EPSG:3857')
  if (s.multiWorld !== !0 && t.isGlobal()) {
    const e = t.getExtent().slice()
    return ((e[0] = -1 / 0), (e[2] = 1 / 0), ol(e, !1, !1))
  }
  return T_
}
function O_(s) {
  ...
  if ((!h && !_ && d.isGlobal() && ((g = !1), (_ = f)), s.resolutions !== void 0)) {
    ...
    ;((e = m[o]),
      (n = m[a] !== void 0 ? m[a] : m[m.length - 1]),
      s.constrainResolution ? (t = S_(m, c, !g && _, u)) : (t = al(e, n, c, !g && _, u)))
  } else {
    const p = (f ? Math.max(Gt(f), pi(f)) : (360 * Jh.degrees) / d.getMetersPerUnit()) / R_ / Math.pow(2, Cr),
    ...
    ;((e = s.maxResolution),
      ...
      (a = o + Math.floor(Math.log(e / n) / Math.log(l))),
      (n = e / Math.pow(l, a - o)),
      s.constrainResolution ? (t = v_(l, e, n, c, !g && _, u)) : (t = al(e, n, c, !g && _, u)))
  }
  return { constraint: t, maxResolution: e, minResolution: n, minZoom: o, zoomFactor: l }
}
function D_(s) {
  if (s.enableRotation !== void 0 ? s.enableRotation : !0) {
    const e = s.constrainRotation
    return e === void 0 || e === !0 ? b_() : e === !1 ? ll : typeof e == 'number' ? M_(e) : ll
  }
  return I_
}
function k_(s) {
...
class N_ extends w_ {
  ...
  isVisible(t) {
    ...
    const n = this.getMapInternal()
    ;(!t && n && (t = n.getView()),
      t instanceof hl ? (e = { viewState: t.getState(), extent: t.calculateExtent() }) : (e = t),
      !e.layerStatesArray && n && (e.layerStatesArray = n.getLayerGroup().getLayerStatesArray()))
    let i
    e.layerStatesArray ? (i = e.layerStatesArray.find(o => o.layer === this)) : (i = this.getLayerState())
    const r = this.getExtent()
  ...
  getAttributions(t) {
    ...
    const n = this.getSource()
    if ((n && (e = n.getAttributions()), !e)) return []
    const i = t instanceof hl ? t.getViewStateAndExtent() : t
    let r = e(i)
    return (Array.isArray(r) || (r = [r]), r)
  }
  render(t, e) {
...
function j_(s, t, e, n, i) {
  Rc(s, t, e || 0, n || s.length - 1, i || X_)
}
...
let Tc = class {
    ...
    for (; e; ) {
      for (let o = 0; o < e.children.length; o++) {
        const a = e.children[o],
          l = e.leaf ? i(a) : a
        os(t, l) && (e.leaf ? n.push(a) : Tr(t, l) ? this._all(a, n) : r.push(a))
      }
      e = r.pop()
    }
    return n
  ...
  _chooseSplitAxis(t, e, n) {
    const i = t.leaf ? this.compareMinX : W_,
  ...
  _allDistMargin(t, e, n, i) {
    ...
    for (let h = e; h < n - e; h++) {
      ...
      ;(hi(o, t.leaf ? r(c) : c), (l += rs(o)))
    }
    for (let h = n - e - 1; h >= e; h--) {
      const c = t.children[h]
      ;(hi(a, t.leaf ? r(c) : c), (l += rs(a)))
    }
    return l
  }
...
function $_(s, t, e, n, i, r) {
  let o = dl.get(t, n, r)
  return (o || ((o = new K_(s, t, e, n, i, r)), dl.set(t, n, r, o)), o)
}
function fl(s, t, e, n) {
...
class or extends sr {
  constructor(t) {
    ...
    if (
      ((this.color_ = t.color !== void 0 ? ks(t.color) : null),
      (this.iconImage_ = $_(
        o,
        a,
      ...
      if (t.size) [h, c] = t.size
        ...
        if (u instanceof HTMLCanvasElement || (u.src && u.complete)) ((h = u.width), (c = u.height))
          ...
          const d = () => {
            ...
            this.setScale(fl(f[0], f[1], t.width, t.height))
          }
          this.listenImageChange(d)
          return
        }
      }
      h !== void 0 && this.setScale(fl(h, c, t.width, t.height))
    }
  }
  clone() {
    let t, e, n
...
function gl(s) {
  return new Vt({ fill: Si(s, ''), stroke: vi(s, ''), text: q_(s), image: H_(s) })
}
function Si(s, t) {
  const e = s[t + 'fill-color']
  if (e) return e === 'none' ? null : new je({ color: e })
}
function vi(s, t) {
...
const _l = { RENDER_ORDER: 'renderOrder' }
class J_ extends N_ {
  constructor(t) {
    t = t || {}
    const e = Object.assign({}, t)
  ...
  getRenderOrder() {
    return this.get(_l.RENDER_ORDER)
  }
  getStyle() {
    return this.style_
  }
  ...
  renderDeclutter(t) {
    ;(t.declutterTree || (t.declutterTree = new Tc(9)), this.getRenderer().renderDeclutter(t))
  }
  setRenderOrder(t) {
    this.set(_l.RENDER_ORDER, t)
  }
  setStyle(t) {
    let e
    if (t === void 0) e = E_
      ...
      for (let r = 0; r < n; ++r) {
        const o = t[r]
        o instanceof Vt ? (i[r] = o) : (i[r] = gl(o))
      }
      e = i
    } else e = gl(t)
...
class Ni extends Sc {
  ...
  appendFlatPointCoordinates(t, e) {
    ...
    for (let a = 0, l = t.length; a < l; a += e)
      ((i[0] = t[a]), (i[1] = t[a + 1]), ag(n, i) && ((r[o++] = i[0]), (r[o++] = i[1])))
    return o
  }
...
class pl extends Ni {
  ...
  drawFlatCoordinatess_(t, e, n, i) {
    ...
    for (let h = 0; h < l; ++h) {
      ...
      ;(this.instructions.push(f),
        ...
        a && (this.instructions.push(ml), this.hitDetectionInstructions.push(ml)),
        (e = c))
    }
    return (
      o && (this.instructions.push(as), this.hitDetectionInstructions.push(as)),
  ...
  drawCircle(t, e) {
    ...
    ;(this.instructions.push(Qe, h),
      ...
      n.fillStyle !== void 0 && (this.instructions.push(as), this.hitDetectionInstructions.push(as)),
  ...
  drawText(t, e) {
    ...
    if (
      ...
      for (let _ = 0, m = u.length; _ < m; ++_) {
        let p
        d ? (p = em(d * this.resolution, h, g, u[_], c)) : (p = [h.slice(g, u[_])])
        for (let y = 0, x = p.length; y < x; ++y) {
          const E = p[y]
          let C = 0,
            R = E.length
          if (f == null) {
            const S = nm(r.maxAngle, E, 0, E.length, 2)
            ;((C = S[0]), (R = S[1]))
          }
  ...
  saveTextStates_() {
    ...
    r in this.textStates ||
      (this.textStates[r] = {
        ...
        justify: e.justify,
        textBaseline: e.textBaseline || Gs,
        scale: e.scale,
      })
    ...
    if (!t) this.text_ = ''
      ...
      if (!a) ((r = null), (this.textStrokeState_ = r))
        ...
        ;((r.lineCap = a.getLineCap() || Ns),
          ...
          (r.strokeStyle = ee(a.getColor() || wi)))
      }
      n = this.textState_
      const l = t.getFont() || Ec
      g_(l)
      ...
      ;((n.overflow = t.getOverflow()),
        ...
        (n.textBaseline = t.getTextBaseline() || Gs),
...
const sm = { Circle: pl, Default: Ni, Image: Q_, LineString: tm, Polygon: pl, Text: im }
class yl {
  constructor(t, e, n, i) {
    ;((this.tolerance_ = t),
      (this.maxExtent_ = e),
...
class lm extends rm {
  ...
  useContainer(t, e, n) {
    ...
    if (
      t &&
      t.className === i &&
      (!n || (t && t.style.backgroundColor && ln(ks(t.style.backgroundColor), ks(n))))
    ) {
      const a = t.firstElementChild
      a instanceof HTMLCanvasElement && (o = a.getContext('2d'))
    }
  ...
  dispatchRenderEvent_(t, e, n) {
    const i = this.getLayer()
    if (i.hasListener(t)) {
      const r = new om(t, this.inversePixelTransform, n, e)
      i.dispatchEvent(r)
    }
  }
  preRender(t, e) {
...
function hm(s, t, e, n, i, r, o, a, l, h, c, u) {
  let d = s[t],
    f = s[t + 1],
    g = 0,
    _ = 0,
...
const Cl = new RegExp('[֑-ࣿיִ-﷿ﹰ-ﻼࠀ-࿿-]')
function Sr(s, t) {
  return (
    t === 'start' ? (t = Cl.test(s) ? 'right' : 'left') : t === 'end' && (t = Cl.test(s) ? 'left' : 'right'),
    Xs[t]
  )
}
function cm(s, t, e) {
...
class um {
  ...
  createLabel(t, e, n, i) {
    ...
    const o = i ? this.strokeStates[i] : null,
      ...
      u = Array.isArray(t),
      d = l.justify ? Xs[l.justify] : Sr(Array.isArray(t) ? t[0] : t, l.textAlign || Ri),
...
`
  ...
  drawLabelWithPointPlacement_(t, e, n, i) {
    const r = this.textStates[e],
      ...
      l = this.pixelRatio,
      h = Sr(Array.isArray(t) ? t[0] : t, r.textAlign || Ri),
      c = Xs[r.textBaseline || Gs],
    ...
    for (; c < u; ) {
      ...
      switch (w[0]) {
            ...
            if (l) {
              ...
              if (Lt === 'obstacle') {
                ...
                if (zt) {
                  ...
                  if (((Pt = zt[vt]), delete zt[vt], (ae = El(Pt)), l.collides(ae))) continue
                }
        ...
        case M.DRAW_CHARS:
          ...
          const ra = mc(h, Bi, ft, 2),
            oa = Math.abs(ei[0]) * sl(ti, C, ni)
          if (Gc || oa <= ra) {
            const St = this.textStates[R].textAlign,
              _n = (ra - oa) * Sr(C, St),
              Pt = hm(h, Bi, ft, 2, C, _n, jc, Math.abs(ei[0]), sl, ti, ni, I ? 0 : this.viewRotation_)
            t: if (Pt) {
              const ae = []
              let vt, Vi, Ui, xt, Ft
              if (v)
...
class wl {
  ...
  createExecutors_(t) {
    for (const e in t) {
      ...
      for (const r in i) {
        const o = i[r]
        n[r] = new um(this.resolution_, this.pixelRatio_, this.overlaps_, o)
      }
    }
  }
  hasExecutors(t) {
  ...
  forEachFeatureAtCoordinate(t, e, n, i, r, o) {
    ...
    let u
    this.renderBuffer_ !== void 0 && ((u = se()), Yh(u, t), Di(u, e * (this.renderBuffer_ + i), u))
    const d = dm(i)
    let f
    function g(C, R) {
...
const Jt = 0.5
function gm(s, t, e, n, i, r, o) {
  const a = s[0] * Jt,
    l = s[1] * Jt,
    h = Kt(a, l)
  h.imageSmoothingEnabled = !1
  const c = h.canvas,
    u = new fm(h, Jt, i, null, o),
    d = e.length,
...
function Rl(s, t, e, n, i, r, o) {
  ...
  return (Em(s, t, e, n, r, o), a)
}
function Em(s, t, e, n, i, r) {
  const o = e.getGeometryFunction()(t)
  if (!o) return
  const a = o.simplifyTransformed(n, i)
  if (e.getRenderer()) Ic(s, a, e, t)
  else {
    const h = vc[a.getType()]
    h(s, a, e, t, r)
  }
}
function Ic(s, t, e, n) {
...
class Mm extends lm {
  ...
  setupCompositionContext_() {
    if (this.opacity_ !== 1) {
      const t = Kt(this.context.canvas.width, this.context.canvas.height, xl)
  ...
  releaseCompositionContext_() {
    if (this.opacity_ !== 1) {
      ...
      ;((this.context.globalAlpha = this.opacity_),
        ...
        xl.push(this.compositionContext_.canvas),
        (this.compositionContext_ = null))
    }
  }
  renderDeclutter(t) {
  ...
  getFeatures(t) {
    return new Promise(e => {
      if (!this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
        ...
        this.hitDetectionImageData_ = gm(n, c, this.renderedFeatures_, h.getStyleFunction(), l, r, o)
      }
      e(_m(t, this.renderedFeatures_, this.hitDetectionImageData_))
    })
  }
  forEachFeatureAtCoordinate(t, e, n, i, r) {
  ...
  prepareFrame(t) {
    ...
    this.replayGroup_ = null
    const C = new yl(so(u, d), p, u, d)
    let R
    this.getLayer().getDeclutter() && (R = new yl(so(u, d), p, u, d))
    let v
    ...
    const D = C.finish(),
      nt = new wl(p, u, d, n.getOverlaps(), D, e.getRenderBuffer())
    return (
      R && (this.declutterExecutorGroup = new wl(p, u, d, n.getOverlaps(), R.finish(), e.getRenderBuffer())),
      (this.renderedResolution_ = u),
      (this.renderedRevision_ = f),
      (this.renderedRenderOrder_ = _),
  ...
  renderFeature(t, e, n, i, r, o) {
    ...
    if (Array.isArray(n))
      for (let l = 0, h = n.length; l < h; ++l)
        a = Rl(i, t, n[l], e, this.boundHandleStyleImageChange_, r, o) || a
    else a = Rl(i, t, n, e, this.boundHandleStyleImageChange_, r, o)
    return a
  }
}
class Jo extends J_ {
...
class zs {
  constructor(t) {
    ;((this.rbush_ = new Tc(t)), (this.items_ = {}))
  }
  insert(t, e) {
...
class Qo extends bm {
  constructor(t) {
    ;((t = t || {}),
      ...
      t.loader !== void 0
        ...
        : this.url_ !== void 0 && (tt(this.format_, 7), (this.loader_ = Sl(this.url_, this.format_))),
      (this.strategy_ = t.strategy !== void 0 ? t.strategy : Lm))
    const e = t.useSpatialIndex !== void 0 ? t.useSpatialIndex : !0
    ;((this.featuresRtree_ = e ? new zs() : null),
      (this.loadedExtentsRtree_ = new zs()),
  ...
  setUrl(t) {
    ;(tt(this.format_, 7), (this.url_ = t), this.setLoader(Sl(t, this.format_)))
  }
}
class Am extends pt {
  constructor(t, e, n) {
...
function Bs(s, t, e) {
  ...
  let r
  if (
    (n && i && !kg(n, i) ? (r = (t ? s.clone() : s).transform(t ? n : i, t ? i : n)) : (r = s),
...
class Wm extends Mc {
  ...
  readFeature(t, e) {
    return this.readFeatureFromObject(ls(t), this.getReadOptions(t, e))
  }
  readFeatures(t, e) {
    return this.readFeaturesFromObject(ls(t), this.getReadOptions(t, e))
  }
  ...
  readGeometry(t, e) {
    return this.readGeometryFromObject(ls(t), this.getReadOptions(t, e))
  }
  readGeometryFromObject(t, e) {
    return P()
  }
  readProjection(t) {
    return this.readProjectionFromObject(ls(t))
  }
...
class rn extends We {
  ...
  closestPointXY(t, e, n, i) {
    return i < hn(this.getExtent(), t, e)
      ...
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ...
          (this.maxDeltaRevision_ = this.getRevision())),
        Yg(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, this.maxDelta_, !0, t, e, n, i))
  }
  containsXY(t, e) {
  ...
  getFlatInteriorPoints() {
    if (this.flatInteriorPointsRevision_ != this.getRevision()) {
      const t = Ym(this.flatCoordinates, 0, this.endss_, this.stride)
...
class oi extends Wm {
  ...
  writeFeatureObject(t, e) {
    ...
    const r = t.getProperties(),
      o = t.getGeometry()
    return (o && ((n.geometry = oo(o, e)), delete r[t.getGeometryName()]), Vn(r) || (n.properties = r), n)
  }
  writeFeaturesObject(t, e) {
    e = this.adaptOptions(e)
    const n = []
  ...
  writeGeometryObject(t, e) {
    return oo(t, this.adaptOptions(e))
  }
}
function ro(s, t) {
  if (!s) return null
...
class s0 extends Mc {
  ...
  readFeature(t, e) {
    return this.readFeatureFromText(hs(t), this.adaptOptions(e))
  }
  readFeatureFromText(t, e) {
    return P()
  }
  readFeatures(t, e) {
    return this.readFeaturesFromText(hs(t), this.adaptOptions(e))
  }
  readFeaturesFromText(t, e) {
    return P()
  }
  readGeometry(t, e) {
    return this.readGeometryFromText(hs(t), this.adaptOptions(e))
  }
  readGeometryFromText(t, e) {
    return P()
  }
  readProjection(t) {
    return this.readProjectionFromText(hs(t))
  }
...
class Gi extends We {
  ...
  clone() {
    const t = new Gi(this.flatCoordinates.slice(), void 0, this.layout)
    return (t.applyProperties(this), t)
  }
  closestPointXY(t, e, n, i) {
    const r = this.flatCoordinates,
...
Gi.prototype.transform
const r0 = { POINT: jt, LINESTRING: Ut, POLYGON: Xt, MULTIPOINT: Jn, MULTILINESTRING: sn, MULTIPOLYGON: rn },
  bc = 'EMPTY',
  Lc = 'Z',
  Pc = 'M',
  o0 = 'ZM',
...
class h0 {
  ...
  parseGeometryLayout_() {
    ...
    if (this.isTokenType(z.TEXT)) {
      const n = e.value
      ;(n === Lc ? (t = 'XYZ') : n === Pc ? (t = 'XYM') : n === o0 && (t = 'XYZM'),
        t !== 'XY' && this.consume_())
    }
    return t
  }
  ...
  isEmptyGeometry_() {
    const t = this.isTokenType(z.TEXT) && this.token_.value == bc
...
function u0(s) {
  const t = [],
    e = s.getGeometries()
  for (let n = 0, i = e.length; n < i; ++n) t.push(Oc(e[n]))
  return t.join(',')
}
function ta(s) {
  const t = s.getCoordinates(),
...
function d0(s) {
  const t = [],
    e = s.getLineStrings()
  for (let n = 0, i = e.length; n < i; ++n) t.push('(' + ta(e[n]) + ')')
  return t.join(',')
}
function Ac(s) {
  const t = [],
...
function g0(s) {
  const t = s.getLayout()
  let e = ''
  return ((t === 'XYZ' || t === 'XYZM') && (e += Lc), (t === 'XYM' || t === 'XYZM') && (e += Pc), e)
}
const _0 = {
  Point: Fc,
  LineString: ta,
...
class y0 extends ar {
  constructor(t) {
    ...
    ;((this.geometryFunction_ = n),
      ...
      (this.overlay_ = new Jo({
        source: new Qo({ useSpatialIndex: !1, wrapX: t.wrapX ? t.wrapX : !1 }),
      ...
      t.freehand
        ? (this.freehandCondition_ = Ys)
        : (this.freehandCondition_ = t.freehandCondition ? t.freehandCondition : Xm),
      this.traceCondition_,
      this.setTrace(t.trace || !1),
      (this.traceState_ = { active: !1 }),
      (this.traceSource_ = t.traceSource || t.source || null),
      this.addChangeListener(Ws.ACTIVE, this.updateState_))
  }
  setTrace(t) {
    let e
    ;(t ? (t === !0 ? (e = Ys) : (e = t)) : (e = Nm), (this.traceCondition_ = e))
  }
  setMap(t) {
        ...
        : this.condition_(t)
          ? ((this.lastDragTime_ = Date.now()),
            (this.downTimeout_ = setTimeout(() => {
              this.handlePointerMove_(new Om(ht.POINTERMOVE, t.map, t.originalEvent, !1, t.frameState))
...
class C0 extends ar {
  constructor(t) {
    ;(super(t),
      ...
      (this.condition_ = t.condition ? t.condition : zm),
      ...
      (this.insertVertexCondition_ = t.insertVertexCondition ? t.insertVertexCondition : Ys),
      ...
      (this.dragSegments_ = []),
      (this.overlay_ = new Jo({
        source: new Qo({ useSpatialIndex: !1, wrapX: !!t.wrapX }),
...
function bl(s, t, e) {
  ...
  const i = H(s)
  return ((Yn[0] = H(t.segment[0])), (Yn[1] = H(t.segment[1])), Ig(i, Yn))
}
function Ll(s, t, e) {
  const n = t.geometry
  if (n.getType() === 'Circle' && t.index === ui) return Zn(n.getClosestPoint(H(s)))
  const i = H(s)
  return ((Yn[0] = H(t.segment[0])), (Yn[1] = H(t.segment[1])), Zn(Go(i, Yn)))
}
function R0() {
  const s = wc()
  return function (t, e) {
...
class v0 extends ar {
  ...
  snapTo(t, e, n) {
    ...
    const i = H(e),
      r = er(Di(It([i]), n.getView().getResolution() * this.pixelTolerance_)),
...
class I0 extends ar {
  constructor(t) {
    ...
    ;((this.layerFilter_ = e),
      ...
      (this.condition_ = t.condition ? t.condition : Ys),
      (this.lastFeature_ = null),
      this.addChangeListener(Ws.ACTIVE, this.handleActiveChanged_))
  }
  handleDownEvent(t) {
...
const D0 = ['Point', 'LineString', 'Polygon', 'Circle'],
  ...
  N0 = new Vt({
    fill: new je({ color: 'rgba(255,255,255,0.5)' }),
    stroke: new _e({ width: 2.5, color: 'red' }),
    image: new Hn({ radius: 5, stroke: new _e({ width: 2.5, color: 'red' }) }),
  }),
...
class X0 extends xe {
  ...
  addFeatureFromWKT(t, e, n = 'EPSG:4326') {
    ...
    let i
    if (typeof n == 'string') i = new cs().readFeature(t, { dataProjection: n, featureProjection: this.#s })
    else {
      const { style: o, ...a } = n
      ;((i = new cs().readFeature(t, a)), o && i.setStyle(o))
    }
    const r = F0(t)
  ...
  addFeatureFromJSON(t, e = 'EPSG:4326') {
    ...
    if (A0(n)) {
      let i
      if (typeof e == 'string') i = new oi().readFeature(n, { dataProjection: e, featureProjection: this.#s })
      else {
        const { style: h, ...c } = e
  ...
  #b(t) {
    ...
    const i = kl + 1
    ;((this.#g = new Jo({ zIndex: i, source: this.#t, className: this.#G(t), style: e })),
  ...
  #D(t) {
    const { feature: e, id: n } = this.#R(t),
      i = new oi().writeFeatureObject(e, { dataProjection: this.#h, featureProjection: this.#s }),
      r = new oi().writeFeature(e, { dataProjection: this.#h, featureProjection: this.#s })
  ...
  #T(t) {
    ...
    const g = new cs().writeFeature(f, { dataProjection: this.#h, featureProjection: this.#h }),
      _ = new oi().writeFeatureObject(f, { dataProjection: this.#h, featureProjection: this.#h })
    _.properties = c
