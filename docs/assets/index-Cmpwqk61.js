...
class qi extends Jn {
  ...
  onceInternal(t, e) {
    ...
    if (Array.isArray(t)) {
      const n = t.length
      i = new Array(n)
      for (let r = 0; r < n; ++r) i[r] = kn(this, t[r], e)
    } else i = kn(this, t, e)
    return ((e.ol_key = i), i)
  }
  unInternal(t, e) {
...
class ut extends Xt {
  ...
  insertAt(t, e) {
    ...
    ;(this.unique_ && this.assertUnique_(e),
      ...
      this.updateLength_(),
      this.dispatchEvent(new un(ot.ADD, e, t)))
  }
  pop() {
  ...
  removeAt(t) {
    ...
    return (this.array_.splice(t, 1), this.updateLength_(), this.dispatchEvent(new un(ot.REMOVE, e, t)), e)
  }
  setAt(t, e) {
    ...
    ;((this.array_[t] = e),
      this.dispatchEvent(new un(ot.REMOVE, n, t)),
      this.dispatchEvent(new un(ot.ADD, e, t)))
  }
  updateLength_() {
...
function hr(s, t) {
  let e
  return ((e = t(Qn(s))), e || ((e = t(ts(s))), e) || ((e = t(es(s))), e) || ((e = t(Ke(s))), e) ? e : !1)
}
function Xs(s) {
  let t = 0
  return (is(s) || (t = $(s) * Zt(s)), t)
}
function Qn(s) {
  return [s[0], s[1]]
}
...
const $i = 6378137,
  ...
  Ol = [-ui, -ui, ui, ui],
  kl = [-180, -85, 180, 85],
  dn = $i * Math.log(Math.tan(Math.PI / 2))
class ti extends sa {
  constructor(t) {
    super({
      code: t,
...
function fn(s, t) {
  return Math.floor(ns(s, t))
}
function gn(s, t) {
  return Math.ceil(ns(s, t))
}
function Vl(s, t) {
  ...
  if (r) n = r(t, e)
    ...
    if ((o == 'degrees' && !i) || i == 'degrees') n = t
      ...
      if (a === ha && o !== 'degrees') n = t * s.getMetersPerUnit()
        ...
        h = a(h, h, 2)
        const c = Gn(h.slice(0, 2), h.slice(2, 4)),
          u = Gn(h.slice(4, 6), h.slice(6, 8))
        n = (c + u) / 2
      }
...
function Dt(s, t, e) {
  return Nn(t, e)(s, void 0, s.length)
}
function We(s, t) {
  return s
}
        ...
        i.getUnits() == 'tile-pixels'
          ? function (r, o, a) {
              const l = i.getExtent(),
                h = i.getWorldExtent(),
                c = Zt(h) / Zt(l)
              return (Re(io, h[0], h[3], c, -c, 0, 0, 0), Ge(r, 0, r.length, a, io, o), Nn(i, e)(r, o, a))
            }
          : Nn(i, e)
...
class be extends ca {
  ...
  setFlatCoordinates(t, e) {
    ;((this.stride = Xn(t)), (this.layout = t), (this.flatCoordinates = e))
  }
  setCoordinates(t, e) {
    F()
  }
...
class Xi extends be {
  ...
  setCoordinates(t, e) {
    ;(this.setLayout(e, t, 1),
      ...
      (this.flatCoordinates.length = rs(this.flatCoordinates, 0, t, this.stride)),
      this.changed())
  }
}
class At extends be {
  ...
  computeExtent(t) {
    return An(this.flatCoordinates, t)
  }
  getType() {
    return 'Point'
  }
...
function ya(s, t, e, i, n) {
  ...
  for (let r = 1, o = e.length; r < o; ++r)
    if (dh(s, e[r - 1], e[r], i, n) && !os(s, e[r - 1], e[r], i, n)) return !1
  return !0
}
...
class Rt extends be {
  ...
  clone() {
    const t = new Rt(this.flatCoordinates.slice(), this.layout, this.ends_.slice())
    return (t.applyProperties(this), t)
  }
  closestPointXY(t, e, i, n) {
    return n < Ve(this.getExtent(), t, e)
...
function xh(s, t, e, i) {
  ...
  return (n.push(n[0], n[1]), new Rt(n, 'XY', [n.length]))
}
function ro(s) {
  if (is(s)) throw new Error('Cannot create polygon from empty extent')
  const t = s[0],
    e = s[1],
    i = s[2],
    n = s[3],
    r = [t, e, t, n, i, n, i, e, t, e]
  return new Rt(r, 'XY', [r.length])
}
function Eh(s, t, e) {
  t = t || 32
  const i = s.getStride(),
...
class Gt extends be {
  ...
  intersectsExtent(t) {
    return os(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t)
  }
  setCoordinates(t, e) {
    ;(this.setLayout(e, t, 1),
      this.flatCoordinates || (this.flatCoordinates = []),
...
class as {
  ...
  setScale(t) {
    ;((this.scale_ = t), (this.scaleArray_ = Pt(t)))
  }
  listenImageChange(t) {
    F()
  }
...
const Hs = {},
  Mh = (function () {
    ...
    function a(h, c, u) {
      ...
      for (let f = 0; f < i; ++f) {
        const g = e[f]
        if (((o = Bn(h + ' ' + c + ' ' + t + g, n)), u != g)) {
          const _ = Bn(h + ' ' + c + ' ' + t + u + ',' + g, n)
          d = d && _ != o
        }
      }
      return !!d
...
`,
    ...
    .reduce((n, r) => Math.max(n, Bn(s, r)), 0)
  return ((e[t] = i), i)
}
function Oh(s, t) {
  const e = [],
...
function Gh(s, t) {
  if (!ys) {
    ...
    ys = [new Mt({ image: new Ue({ fill: e, stroke: i, radius: 5 }), fill: e, stroke: i })]
  }
  return ys
}
function ba() {
  const s = {},
    ...
    i = 3
  return (
    (s.Polygon = [new Mt({ fill: new qt({ color: [255, 255, 255, 0.5] }) })]),
    (s.MultiPolygon = s.Polygon),
    (s.LineString = [
      new Mt({ stroke: new Nt({ color: t, width: i + 2 }) }),
      new Mt({ stroke: new Nt({ color: e, width: i }) }),
    ]),
...
class vr {
  constructor(t) {
    ;((t = t || {}),
      ...
      (this.rotateWithView_ = t.rotateWithView),
      (this.scale_ = t.scale),
      (this.scaleArray_ = Pt(t.scale !== void 0 ? t.scale : 1)),
      (this.text_ = t.text),
  ...
  setScale(t) {
    ;((this.scale_ = t), (this.scaleArray_ = Pt(t !== void 0 ? t : 1)))
  }
  setStroke(t) {
    this.stroke_ = t
  }
...
class Yt extends Xt {
  ...
  cancelAnimations() {
    ...
    for (let e = 0, i = this.animations_.length; e < i; ++e) {
      ...
      if ((n[0].callback && mn(n[0].callback, !1), !t))
  ...
  calculateExtent(t) {
    ...
    return ss(e, this.getProjection())
  }
  ...
  fitInternal(t, e) {
    ...
    e.duration !== void 0
      ...
      : ((this.targetResolution_ = l), (this.targetCenter_ = _), this.applyTargetState_(!1, !0), mn(m, !0))
  }
  centerOn(t, e, i) {
...
let Ma = class {
    ...
    for (; e; ) {
      for (let o = 0; o < e.children.length; o++) {
        const a = e.children[o],
          l = e.leaf ? n(a) : a
        yn(t, l) && (e.leaf ? i.push(a) : ws(t, l) ? this._all(a, i) : r.push(a))
      }
      e = r.pop()
    }
    return i
  ...
  _allDistMargin(t, e, i, n) {
    ...
    for (let h = e; h < i - e; h++) {
      ...
      ;(Oi(o, t.leaf ? r(c) : c), (l += pn(o)))
    }
    for (let h = i - e - 1; h >= e; h--) {
      const c = t.children[h]
      ;(Oi(a, t.leaf ? r(c) : c), (l += pn(a)))
    }
    return l
  }
...
function ac(s, t, e, i, n, r) {
  let o = Vn.get(t, i, r)
  return (o || ((o = new oc(s, t, e, i, n, r)), Vn.set(t, i, r, o)), o)
}
function xo(s, t, e, i) {
...
class ds extends as {
  constructor(t) {
    ...
    if (
      ((this.color_ = t.color !== void 0 ? Wn(t.color) : null),
      (this.iconImage_ = ac(
        o,
        a,
...
function Eo(s) {
  return new Mt({ fill: Vi(s, ''), stroke: Ki(s, ''), text: lc(s), image: hc(s) })
}
function Vi(s, t) {
...
class cc extends us {
  ...
  setStyle(t) {
    ...
    else if (t instanceof Mt) e = t
    else if (Array.isArray(t)) {
      const i = t.length,
        n = new Array(i)
      for (let r = 0; r < i; ++r) {
        const o = t[r]
        o instanceof Mt ? (n[r] = o) : (n[r] = Eo(o))
      }
      e = n
    } else e = Eo(t)
...
class Qi extends Oa {
  ...
  appendFlatPointCoordinates(t, e) {
    ...
    for (let a = 0, l = t.length; a < l; a += e)
      ((n[0] = t[a]), (n[1] = t[a + 1]), $n(i, n) && ((r[o++] = n[0]), (r[o++] = n[1])))
    return o
  }
...
class To extends Qi {
  ...
  drawFlatCoordinatess_(t, e, i, n) {
    ...
    return (
      o && (this.instructions.push(xn), this.hitDetectionInstructions.push(xn)),
  ...
  drawCircle(t, e) {
    ...
    ;(this.instructions.push(De, h),
      ...
      i.fillStyle !== void 0 && (this.instructions.push(xn), this.hitDetectionInstructions.push(xn)),
  ...
  saveTextStates_() {
    ...
    r in this.textStates ||
      (this.textStates[r] = {
        ...
        justify: e.justify,
        textBaseline: e.textBaseline || zn,
        scale: e.scale,
      })
  ...
  setTextStyle(t, e) {
    ...
    if (!t) this.text_ = ''
      ...
      ;((i.overflow = t.getOverflow()),
        ...
        (i.textBaseline = t.getTextBaseline() || zn),
...
const mc = { Circle: To, Default: Qi, Image: uc, LineString: dc, Polygon: To, Text: _c }
class So {
  constructor(t, e, i, n) {
    ;((this.tolerance_ = t),
      (this.maxExtent_ = e),
...
class Da extends pc {
  ...
  useContainer(t, e, i) {
    ...
    if (
      t &&
      t.className === n &&
      (!i || (t && t.style.backgroundColor && ce(Wn(t.style.backgroundColor), Wn(i))))
    ) {
...
class Cc {
  ...
  createLabel(t, e, i, n) {
    ...
    const o = n ? this.strokeStates[n] : null,
      ...
      u = Array.isArray(t),
      d = l.justify ? Kn[l.justify] : Ts(Array.isArray(t) ? t[0] : t, l.textAlign || zi),
    ...
    for (; c < u; ) {
      ...
      switch (w[0]) {
        ...
        case b.CUSTOM:
          ...
          const nn = w[3],
            qe = w[4],
            sn = w.length == 6 ? w[5] : void 0
          ;((M.geometry = nn), (M.feature = k), c in N || (N[c] = []))
          const fe = N[c]
          ;(sn ? sn(h, d, f, 2, fe) : ((fe[0] = h[d]), (fe[1] = h[d + 1]), (fe.length = 2)), qe(fe, M), ++c)
          break
        case b.DRAW_IMAGE:
          ...
          if (!E && w.length >= 20) {
            ...
            const bt = w[24]
            ;((_ = (Tt.anchorY - bt) * this.pixelRatio),
              (w[5] = _),
              (vi = E.height),
              (w[6] = vi),
              (yt = E.width),
            ...
            if (l) {
              ...
              if (It === 'obstacle') {
                ...
                if (Ot) {
                  ...
                  if (((bt = Ot[St]), delete Ot[St], ($t = Ro(bt)), l.collides($t))) continue
                }
                if (l.collides(Tt.declutterBox)) continue
                ;(bt && (l.insert($t), this.replayImageOrLabel_.apply(this, bt)), l.insert(Tt.declutterBox))
              }
            }
        ...
        case b.DRAW_CHARS:
          ...
          const Vr = wa(h, ln, dt, 2),
            Kr = Math.abs(Ii[0]) * uo(Ri, C, bi)
          if (ul || Kr <= Vr) {
            const Tt = this.textStates[T].textAlign,
              Qe = (Vr - Kr) * Ts(C, Tt),
              bt = xc(h, ln, dt, 2, C, Qe, dl, Math.abs(Ii[0]), uo, Ri, bi, I ? 0 : this.viewRotation_)
            t: if (bt) {
              const $t = []
              let St, hn, cn, xt, Ft
              if (R)
                for (St = 0, hn = bt.length; St < hn; ++St) {
                  ;((Ft = bt[St]),
                    (cn = Ft[4]),
                    (xt = this.createLabel(cn, T, '', R)),
                    (g = Ft[2] + (Ii[0] < 0 ? -ms : ms)),
...
class Tc extends Oa {
  constructor(t, e, i, n, r, o, a) {
    ;(super(),
      ...
      (this.extent_ = i),
      (this.transform_ = n),
      (this.transformRotation_ = n ? ns(Math.atan2(n[1], n[0]), 10) : 0),
...
class Mr extends Na {
  constructor(t) {
    ...
    ;((this.featuresRtree_ = e ? new Un() : null),
      (this.loadedExtentsRtree_ = new Un()),
...
class Bc extends nr {
  ...
  scheduleExpireIconCache(t) {
    Vn.canExpireCache() && t.postRenderFunctions.push(Vc)
  }
}
function Vc(s, t) {
  Vn.expire()
...
class Zc {
  ...
  reprioritize() {
    ...
    for (a = 0; a < r; ++a)
      ((o = e[a]),
        (l = t(o)),
        l == Zn ? delete this.queuedElements_[this.keyFunction_(o)] : ((i[n] = l), (e[n++] = o)))
...
function Hc(s, t, e, i, n) {
  if (!s || !(e in s.wantedTiles) || !s.wantedTiles[e][t.getKey()]) return Zn
...
class $c extends Ar {
  constructor(t) {
    ...
    ;((l.className = a),
      ...
      (this.rotation_ = void 0),
      this.autoHide_ && this.element.classList.add(_n))
  }
  handleClick_(t) {
  ...
  render(t) {
    ...
    if (i != this.rotation_) {
      ...
      if (this.autoHide_) {
        const r = this.element.classList.contains(_n)
        !r && i === 0 ? this.element.classList.add(_n) : r && i !== 0 && this.element.classList.remove(_n)
      }
...
class uu extends nr {
  ...
  createOrUpdateGeometry() {
    ...
    ;((n[4] = n[0].slice()),
      this.geometry_ ? this.geometry_.setCoordinates([n]) : (this.geometry_ = new Rt([n])))
  }
  getGeometry() {
    return this.geometry_
  }
}
const En = { BOXSTART: 'boxstart', BOXDRAG: 'boxdrag', BOXEND: 'boxend', BOXCANCEL: 'boxcancel' }
class bs extends at {
  constructor(t, e, i) {
...
class du extends ue {
  ...
  handleDragEvent(t) {
    ;(this.box_.setPixels(this.startPixel_, t.pixel), this.dispatchEvent(new bs(En.BOXDRAG, t.coordinate, t)))
  }
  handleUpEvent(t) {
    ...
    return (
      e && this.onBoxEnd(t),
      this.dispatchEvent(new bs(e ? En.BOXEND : En.BOXCANCEL, t.coordinate, t)),
      !1
    )
  }
  handleDownEvent(t) {
    return this.condition_(t)
      ? ((this.startPixel_ = t.pixel),
        ...
        this.dispatchEvent(new bs(En.BOXSTART, t.coordinate, t)),
        !0)
      : !1
  }
  onBoxEnd(t) {}
  ...
  renderFrame_(t) {
    ...
    ;((this.frameState_ = r),
      ...
      r &&
        ...
        n &&
          (!this.previousExtent_ || (!is(this.previousExtent_) && !Gi(r.extent, this.previousExtent_))) &&
...
class ze extends be {
  ...
  getPolygon(t) {
    ...
    return new Rt(this.flatCoordinates.slice(e, n), this.layout, i)
  }
  getPolygons() {
    const t = this.layout,
      e = this.flatCoordinates,
    ...
    for (let o = 0, a = i.length; o < a; ++o) {
      ...
      const c = new Rt(e.slice(r, h), t, l)
      ;(n.push(c), (r = h))
    }
    return n
  }
...
class en extends be {
  ...
  clone() {
    const t = new en(this.flatCoordinates.slice(), void 0, this.layout)
    return (t.applyProperties(this), t)
  }
  closestPointXY(t, e, i, n) {
    const r = this.flatCoordinates,
...
class Fu {
  constructor(t, e, i, n, r, o) {
    ...
    let a = {}
    const l = Nn(this.targetProj_, this.sourceProj_)
...
function Lu() {
  if (Fs === void 0) {
    ...
    ;((Fs = Ls(t, 0) || Ls(t, 4) || Ls(t, 8)), ls(s), mi.push(s.canvas))
  }
  return Fs
}
function Do(s, t, e, i) {
...
class tr extends Xa {
  ...
  release() {
    ;(this.canvas_ && (ls(this.canvas_.getContext('2d')), mi.push(this.canvas_), (this.canvas_ = null)),
      super.release())
  }
}
class Au extends Da {
  ...
  renderFrame(t, e) {
    ...
    for (let wt = Z.length - 1; wt >= 0; --wt) {
      const V = Z[wt],
        ...
        nn = f.getTileCoordExtent(Ze),
        qe = rt(this.tempTransform, [(y * (nn[0] - v[0])) / _, (y * (v[3] - nn[3])) / _]),
        sn = y * u.getGutterForProjection(r),
        fe = A[V]
      for (const vi in fe) {
        const ge = fe[vi],
          rn = ge.tileCoord,
          on = Ze[1] - rn[1],
          an = Math.round(qe[0] - (on - 1) * lt),
          He = Ze[2] - rn[2],
          gs = Math.round(qe[1] - (He - 1) * Ht),
          yt = Math.round(qe[0] - on * lt),
          It = Math.round(qe[1] - He * Ht),
          Ot = an - yt,
          Jt = gs - It,
          Je = g === V,
        ...
        if (!Fe)
          if (K) {
            w = [yt, It, yt + Ot, It, yt + Ot, It + Jt, yt, It + Jt]
            for (let $e = 0, ln = K.length; $e < ln; ++$e)
              if (g !== V && V < nt[$e]) {
                const dt = K[$e]
                mt([yt, It, yt + Ot, It + Jt], [dt[0], dt[3], dt[4], dt[7]]) &&
                  (_e || (S.save(), (_e = !0)),
                  S.beginPath(),
                  S.moveTo(w[0], w[1]),
                  S.lineTo(w[2], w[3]),
            ...
            ;(K.push(w), nt.push(V))
          } else S.clearRect(yt, It, Ot, Jt)
        ;(this.drawTileImage(ge, t, yt, It, Ot, Jt, sn, Je),
...
const Cn = { PRELOAD: 'preload', USE_INTERIM_TILES_ON_ERROR: 'useInterimTilesOnError' },
  si = [0, 0, 0],
  xe = 5
class $a {
  constructor(t) {
  ...
  getTileCoordForXYAndResolution_(t, e, i, n, r) {
    const o = this.getZForResolution(i),
      ...
      l = this.getOrigin(o),
      h = Pt(this.getTileSize(o), this.tmpSize_)
    let c = (a * (t - l[0])) / i / h[0],
      u = (a * (l[1] - e)) / i / h[1]
    return (
      n ? ((c = gn(c, xe) - 1), (u = gn(u, xe) - 1)) : ((c = fn(c, xe)), (u = fn(u, xe))),
      Mo(o, c, u, r)
    )
  }
  getTileCoordForXYAndZ_(t, e, i, n, r) {
    const o = this.getOrigin(i),
      ...
      l = Pt(this.getTileSize(i), this.tmpSize_)
    let h = (t - o[0]) / a / l[0],
      c = (o[1] - e) / a / l[1]
    return (
      n ? ((h = gn(h, xe) - 1), (c = gn(c, xe) - 1)) : ((h = fn(h, xe)), (c = fn(c, xe))),
      Mo(i, h, c, r)
    )
  }
...
function tl(s, t, e, i) {
  ;((t = t !== void 0 ? t : Xh), (e = Pt(e !== void 0 ? e : Rr)))
  const n = Zt(s),
    r = $(s)
...
class Gu extends Na {
  constructor(t) {
    ...
    const e = [256, 256]
    ;(this.tileGrid && Pt(this.tileGrid.getTileSize(this.tileGrid.getMinZoom()), e),
  ...
  getTilePixelSize(t, e, i) {
    const n = this.getTileGridForProjection(i),
      ...
      o = Pt(n.getTileSize(t), this.tmpSize)
...
class Bu extends Ja {
  ...
  readFeature(t, e) {
    return this.readFeatureFromObject(wn(t), this.getReadOptions(t, e))
  }
  readFeatures(t, e) {
    return this.readFeaturesFromObject(wn(t), this.getReadOptions(t, e))
  }
  ...
  readGeometry(t, e) {
    return this.readGeometryFromObject(wn(t), this.getReadOptions(t, e))
  }
  readGeometryFromObject(t, e) {
    return F()
  }
  readProjection(t) {
    return this.readProjectionFromObject(wn(t))
  }
...
class rd extends us {
  ...
  getPreload() {
    return this.get(Cn.PRELOAD)
  }
  setPreload(t) {
    this.set(Cn.PRELOAD, t)
  }
  getUseInterimTilesOnError() {
    return this.get(Cn.USE_INTERIM_TILES_ON_ERROR)
  }
  setUseInterimTilesOnError(t) {
    this.set(Cn.USE_INTERIM_TILES_ON_ERROR, t)
  }
  getData(t) {
...
class fd extends Ja {
  ...
  readFeature(t, e) {
    return this.readFeatureFromText(Tn(t), this.adaptOptions(e))
  }
  readFeatureFromText(t, e) {
    return F()
  }
  readFeatures(t, e) {
    return this.readFeaturesFromText(Tn(t), this.adaptOptions(e))
  }
  readFeaturesFromText(t, e) {
    return F()
  }
  readGeometry(t, e) {
    return this.readGeometryFromText(Tn(t), this.adaptOptions(e))
  }
  readGeometryFromText(t, e) {
    return F()
  }
  readProjection(t) {
    return this.readProjectionFromText(Tn(t))
  }
...
const gd = { POINT: At, LINESTRING: Gt, POLYGON: Rt, MULTIPOINT: Si, MULTILINESTRING: Ye, MULTIPOLYGON: ze },
  el = 'EMPTY',
  il = 'Z',
  nl = 'M',
  _d = 'ZM',
...
class yd {
  ...
  parseGeometryLayout_() {
    ...
    if (this.isTokenType(B.TEXT)) {
      const i = e.value
      ;(i === il ? (t = 'XYZ') : i === nl ? (t = 'XYM') : i === _d && (t = 'XYZM'),
        t !== 'XY' && this.consume_())
    }
    return t
  }
...
const vn = { DRAWSTART: 'drawstart', DRAWEND: 'drawend', DRAWABORT: 'drawabort' }
class Rn extends at {
  constructor(t, e) {
...
function al(s, t, e) {
  if (t instanceof Gt) {
    Fn(s, t.getCoordinates(), !1, e)
    return
  }
  if (t instanceof Ye) {
    const i = t.getCoordinates()
    for (let n = 0, r = i.length; n < r; ++n) Fn(s, i[n], !1, e)
    return
  }
  if (t instanceof Rt) {
    const i = t.getCoordinates()
    for (let n = 0, r = i.length; n < r; ++n) Fn(s, i[n], !0, e)
    return
  }
  if (t instanceof ze) {
    const i = t.getCoordinates()
    for (let n = 0, r = i.length; n < r; ++n) {
      const o = i[n]
      for (let a = 0, l = o.length; a < l; ++a) Fn(s, o[a], !0, e)
    }
    return
  }
  if (t instanceof Ie) {
...
function ll(s, t, e, i) {
  ...
  return (
    ...
    (As.along = c),
    (As.squaredDistance = ns(se(s, t, u, d), 10)),
    As
  )
}
function fi(s, t) {
...
class Id extends ue {
  constructor(t) {
    ...
    if (!i) {
      ...
      if (n === 'Circle')
        ...
        let r
        ;(n === 'Point' ? (r = At) : n === 'LineString' ? (r = Gt) : n === 'Polygon' && (r = Rt),
          (i = function (o, a, l) {
            return (
              a
                ? n === 'Polygon'
    ...
    ;((this.geometryFunction_ = i),
      ...
      this.addChangeListener(qn.ACTIVE, this.updateState_))
  }
  setTrace(t) {
    let e
  ...
  updateTrace_(t) {
    ...
    if (!e.active || (e.targetIndex === -1 && jn(e.startPx, t.pixel) < this.snapTolerance_)) return
    const i = Rd(t.coordinate, e, this.getMap(), this.snapTolerance_)
  ...
  startDrawing_(t) {
    ...
    ;((this.sketchFeature_ = new _t()),
      ...
      this.dispatchEvent(new Rn(vn.DRAWSTART, this.sketchFeature_)))
  }
  modifyDrawing_(t) {
    const e = this.getMap(),
      i = this.sketchFeature_.getGeometry(),
      n = e.getView().getProjection(),
      r = Xn(this.geometryLayout_)
    let o, a
  ...
  finishDrawing() {
    ...
    ;(this.mode_ === 'LineString'
      ...
      this.dispatchEvent(new Rn(vn.DRAWEND, t)),
  ...
  abortDrawing() {
    const t = this.abortDrawing_()
    t && this.dispatchEvent(new Rn(vn.DRAWABORT, t))
  }
  appendCoordinates(t) {
    const e = this.mode_,
...
class Ld extends ue {
  ...
  writeCircleGeometry_(t, e) {
    const i = e.getCenter(),
      ...
      o = [n, r]
    ;((n.featureSegments = o), (r.featureSegments = o), this.rBush_.insert(An(i), n))
    let a = e
...
class kd extends ue {
  ...
  handleEvent(t) {
    ...
    return (
      e &&
        ...
        this.dispatchEvent(
          new Od(Ad.SNAP, { vertex: t.coordinate, vertexPixel: t.pixel, feature: e.feature }),
        )),
      super.handleEvent(t)
    )
  }
  ...
  snapTo(t, e, i) {
    ...
    const n = J(e),
      r = ss(Hi(gt([n]), i.getView().getResolution() * this.pixelTolerance_)),
...
class Dd extends ue {
  constructor(t) {
    ...
    ;((this.layerFilter_ = e),
      ...
      this.addChangeListener(qn.ACTIVE, this.handleActiveChanged_))
  }
  handleDownEvent(t) {
    ...
    if (
      ...
      return (this.dispatchEvent(new On(js.TRANSLATESTART, e, t.coordinate, this.startCoordinate_, t)), !0)
    }
    return !1
  }
  handleUpEvent(t) {
    if (this.lastCoordinate_) {
      ...
      const e = this.features_ || new ut([this.lastFeature_])
      return (
        this.dispatchEvent(new On(js.TRANSLATEEND, e, t.coordinate, this.startCoordinate_, t)),
        (this.startCoordinate_ = null),
        !0
      )
    }
  ...
  handleDragEvent(t) {
    if (this.lastCoordinate_) {
      ...
      ;(a.forEach(function (l) {
        ...
        this.dispatchEvent(new On(js.TRANSLATING, a, e, this.startCoordinate_, t)))
    }
  }
  handleMoveEvent(t) {
...
var jd = '1.1.2',
  ...
  zo = class extends On {
    ...
    get distance() {
      return this.endAt ? Gn(this.startAt.coord, this.endAt.coord) : 0
    }
  },
  Bo = class extends at {
    dataArray
  ...
  Xd = class extends at {
    ...
    features
    constructor(s, t) {
      ;(super(Lt.COMPLETE), (this.array = s), (this.features = t))
    }
  }
const Ln = [
  {
...
const Kd = ['Point', 'LineString', 'Polygon', 'Circle'],
  Ud = getComputedStyle(document.documentElement).getPropertyValue('--ol-foreground-color'),
  Zd = new Mt({
  ...
  qd = { duration: 500, maxZoom: 14, padding: 100 },
  Pn = ['LineString', 'Polygon'],
...
var Jd = class extends Xt {
  ...
  addFeatureFromWKT(s, t, e = 'EPSG:4326') {
    ...
    let i
    if (typeof e == 'string') i = new Sn().readFeature(s, { dataProjection: e, featureProjection: this.#i })
    else {
      const { style: r, ...o } = e
      ;((i = new Sn().readFeature(s, o)), r && i.setStyle(r))
    }
    const n = Yd(s)
    ...
    if (this.#s) {
      ...
      ;(this.disableSelect(),
        ...
        (this.#C = this.#h.on('drawstart', e => {
          ...
          this.dispatchEvent(new Gs(Lt.DRAW_BEGIN, null, i, c, h, l))
        })),
        (this.#E = this.#h.on('drawend', e => {
          ...
          if (this.#r === 'Circle') {
            const _ = this.#S(i),
              m = new Gs(Lt.DRAW_COMPLETE, _, i, h, g, f, d)
  ...
  enableFreehand() {
    ;((this.#g = !0),
      ...
      Pn.includes(this.#r) && this.enableDraw(this.#r))
  }
  disableFreehand() {
    ;((this.#g = !1),
      this.showToolBar &&
  ...
  select(s, t) {
    ...
    if (
      ...
      const h = qd
      ;(t?.fit !== !1 && (Object.assign(h, t?.fit === !0 ? {} : t?.fit), (h.padding = Bd(h.padding))),
        this.#_.fit(o, h))
    }
    return a
  }
  ...
  disableSelect() {
    return (Mn(this.#c), (this.#c = null), !0)
  }
  enableTranslate(s) {
    return (
    ...
    ;(s !== null && (this.modifyingStyle = s),
      ...
      this.#a.on('modifystart', t => {
        ...
        const e = this.#n(t.features),
          i = new Bo(Lt.MODIFY_BEGIN, e, t.features)
        this.dispatchEvent(i)
      }),
      this.#a.on('modifyend', t => {
        this.dispatchEvent(t)
        const e = this.#n(t.features),
          i = new Bo(Lt.MODIFY_COMPLETE, e, t.features)
        this.dispatchEvent(i)
      }),
      this.enableSnap())
  }
  ...
  enableSnap() {
    ...
    ;((this.#d = new kd({ source: this.#t, intersection: !0 })), this.#s?.addInteraction(this.#d))
  }
  removeFeatures(s) {
    if (s == null) {
  ...
  #F(s) {
    ...
    const n = Ln.filter(o => this.drawTypes.includes(o.type))
    this.supportFreehand && n.push(Ln.find(o => o.name === 'freehand'))
    const r = Ln.filter(o => this.actions.includes(o.name))
    this.allButtons = [...n, ...r]
  }
  #w(s) {
  ...
  #M() {
    const s = e => {
      const i = e.element,
        ...
        [r] = this.#n([i]),
        o = this.#n(n)
      this.dispatchEvent(new Gd(Lt.SELECT, o, r, n, []))
    }
    this.#e.on('add', s)
    const t = e => {
      const i = e.element,
        ...
        o = this.#n([i]),
        a = [i]
      this.dispatchEvent(new Nd(Lt.DESELECT, o, n, r, a))
    }
    this.#e.on('remove', t)
  }
  #A() {
  ...
  #O(s) {
    ...
    return { wkt: new Sn().writeFeature(t, { dataProjection: this.#m, featureProjection: this.#i }), id: e }
  }
  #T(s) {
    let t
  ...
  #S(s) {
    ...
    const d = new Sn().writeFeature(u, { dataProjection: 'EPSG:4326', featureProjection: this.#i }),
  ...
  #v(s, t, e) {
    ...
    if (e) {
      const a = Dt(e, this.#i, 'EPSG:4326'),
        ...
        h = { coord: a, coord3857: l }
      return new zo(Lt.TRANSLATE_END, i, s, o, h)
    }
    return new zo(Lt.TRANSLATE_START, i, s, o)
  }
  #G(s) {
...
const $d = jd,
  Qd = 'LINESTRING(106.55773424492708 26.68974989181626,106.79592190619702 26.712142565234185)',
  tf =
...
function af() {
  console.log('addWKT')
  const s = X.addFeatureFromWKT(Qd, 'line1'),
    t = X.addFeatureFromWKT(tf)
  console.log({ feat1: s, feat2: t })
}
function lf() {
  console.log('addJSON')
  const s = X.addFeatureFromJSON(nf)
  console.log({ f: s })
}
function hf() {
  console.log('addJSONObj')
  const s = X.addFeatureFromJSON(ef),
    t = X.addFeatureFromJSON(sf)
